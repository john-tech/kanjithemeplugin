...
<div id="all">
  ...
  <div id="wrapper" class="cf">
    <div id="content">
      <h1 class="ttl_main">２９画の漢字一覧（漢検級順）</h1>
      ...
      <div class="parts_data">
        <div class="search_narrowdown">
          ...
          <div class="narrowdown_select">
            <select name="select" onChange="location.href=value;" class="select1">
              ...
              <option value="#" selected>２９画</option>
        ...
        <div class="search_data bbushu_menu">
          <ul class="search_menu">
            <li>漢検級順</li>
            <li><a href="bkakusu29">部首別順</a></li>
            <li><a href="ckakusu29">読み順</a></li>
          </ul>
        ...
        <div class="bushu_wrap">
          ...
          <div class="parts_box" id="parts01">
            ...
            <ul class="search_parts">
              <li><a href="4512">驪</a></li>
              <li><a href="4945">爨</a></li>
            </ul>
          </div>
          <div class="parts_box" id="parts">
            <h3 class="ttl_while">漢字検定対象外</h3>
            <ul class="search_parts">
              <li><a href="7099">鸜</a></li>
              <li><a href="7273">麷</a></li>
              <li><a href="7340">韊</a></li>
              <li><a href="7863">钃</a></li>
              <li><a href="8234">讟</a></li>
              <li><a href="9156">纞</a></li>
              <li><a href="18247">靏</a></li>
              <li><a href="19445">㠨</a></li>
              <li><a href="20961">䀍</a></li>
              <li><a href="21176">䄥</a></li>
              <li><a href="23438">䰖</a></li>
              <li><a href="23697">䶑</a></li>
              <li><a href="23720">䶩</a></li>
              <li><a href="23721">䶪</a></li>
              <li><a href="24388">虋</a></li>
              <li><a href="27428">䯁</a></li>
              <li><a href="27469">䥹</a></li>
            </ul>
          </div>
          <aside>
