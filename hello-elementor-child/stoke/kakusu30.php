...
<div id="all">
  ...
  <div id="wrapper" class="cf">
    <div id="content">
      <h1 class="ttl_main">３０画の漢字一覧（漢検級順）</h1>
      ...
      <div class="parts_data">
        <div class="search_narrowdown">
          ...
          <div class="narrowdown_select">
            <select name="select" onChange="location.href=value;" class="select1">
              ...
              <option value="#" selected>３０画</option>
        ...
        <div class="search_data bbushu_menu">
          <ul class="search_menu">
            <li>漢検級順</li>
            <li><a href="bkakusu30">部首別順</a></li>
            <li><a href="ckakusu30">読み順</a></li>
          </ul>
        ...
        <div class="bushu_wrap">
          ...
          <div class="parts_box" id="parts01">
            ...
            <ul class="search_parts">
              <li><a href="3841">鸞</a></li>
            </ul>
          </div>
          <div class="parts_box" id="parts">
            <h3 class="ttl_while">漢字検定対象外</h3>
            <ul class="search_parts">
              <li><a href="5676">驫</a></li>
              <li><a href="7082">鱺</a></li>
              <li><a href="7238">鸝</a></li>
              <li><a href="13204">厵</a></li>
              <li><a href="16619">癵</a></li>
              <li><a href="16947">籱</a></li>
              <li><a href="21057">䂅</a></li>
              <li><a href="21264">䆐</a></li>
              <li><a href="21470">䉹</a></li>
              <li><a href="27886">𩧢</a></li>
            </ul>
          </div>
          <aside>
