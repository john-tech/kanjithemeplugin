...
<body>
     <div id="all">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：鹵部（ろ・しお・しおへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>鹵部とは？</h2>
                              <p><strong>鹵部（ろぶ）は、<span
                                             class="marker">塩、塩分に関する字</span>が属します。</strong>「鹵」は「ろ」「しお」、偏になった形を「しおへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>鹵（しお・しおへん）</option>
                                        ...
                                        <option value="#" selected>鹵（ろ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu11008">漢検級順</a></li>
                                   <li><a href="cbushu11008">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：鹵部（ろ・しお・しおへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical197">English</option>
                                             <option value="bushu11008">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu11008 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:42:05 GMT -->
