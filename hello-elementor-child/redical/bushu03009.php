...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：夕部（ゆうべ・ゆう・た）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>夕部とは？</h2>
                              <p><strong>夕部（せきぶ）は、<span
                                             class="marker">夕暮れや夜に関する字</span>が主に属します。</strong>一説によれば、半分の月（または三日月）の形にかたどられているとも言われています。「夕」は「ゆうべ」「ゆう」「た」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>夕（た）</option>
                                        ...
                                        <option value="#" selected>夕（ゆう・ゆうべ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03009">漢検級順</a></li>
                                   <li><a href="cbushu03009">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：夕部（ゆうべ・ゆう・た）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts08">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13903">夝</a></li>
                                        <li><a href="kanjiy/24203">㚉</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts11">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13904">够</a></li>
                                        <li><a href="kanjiy/13905">夠</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts12">
                                   <h3 class="ttl_while"><a href="kakusu12">１２画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/13906">夡</a></li>
                                        <li><a href="kanjiy/19105">㚊</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical36">English</option>
                                             <option value="bushu03009">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03009 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:44 GMT -->
