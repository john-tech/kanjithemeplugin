...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：二部（に）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>二部とは？</h2>
                              <p><strong>二部（にぶ）は、二の字をもとに作られた字はなく、<span
                                             class="marker">主に字形から文字を整理するために設けられた部首であり、特定の意味は持たない</span>とされます。</strong>「二」は「に」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>二（に）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02003">漢検級順</a></li>
                                   <li><a href="cbushu02003">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：二部（に）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts04">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12691">亓</a></li>
                                        <li><a href="kanjiy/13031">亖</a></li>
                                   </ul>
                              </div>
