...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：皮部（けがわ・ひのかわ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>皮部とは？</h2>
                              <p><strong>皮部（ひぶ）は、<span
                                             class="marker">皮膚に関する字</span>が主に属します。</strong>「皮」は「けがわ」「ひのかわ」と呼んで、「<a
                                        href="bushu09008">革（かくのかわ・つくりがわ）</a>」「<a
                    ...
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>皮（けがわ）</option>
                                        ...
                                        <option value="#" selected>皮（ひのかわ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05015">漢検級順</a></li>
                                   <li><a href="cbushu05015">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：皮部（けがわ・ひのかわ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical107">English</option>
                                             <option value="bushu05015">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05015 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:50 GMT -->
