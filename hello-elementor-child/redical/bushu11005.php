...
<body>
     <div id="all">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：麥・麦部（むぎ・むぎへん・ばくにょう）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>麥・麦部とは？</h2>
                              <p><strong>麥・麦部（ばくぶ）は、<span
                                             class="marker">麦や、麦で作られたものに関する字</span>が主に属します。</strong>「麥・麦」は「むぎ」、偏になった形を「むぎへん」、繞（にょう）になった形を「ばくにょう」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>麥 麦（ばくにょう）</option>
                                        ...
                                        <option value="#" selected>麥 麦（むぎ・むぎへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu11005">漢検級順</a></li>
                                   <li><a href="cbushu11005">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：麥・麦部（むぎ・むぎへん・ばくにょう）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical199">English</option>
                                             <option value="bushu11005">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu11005 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:31 GMT -->
