...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：止部（とめる・とめへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>止部とは？</h2>
                              <p><strong>止部（しぶ）は、<span
                                             class="marker">足の動作に関する字</span>が主に属します。</strong>「止」は「とめる」、偏になった形を「とめへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>止（とめへん・とめる）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04006">漢検級順</a></li>
                                   <li><a href="cbushu04006">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：止部（とめる・とめへん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/27250">㱐</a></li>
                                        <li><a href="kanjiy/27251">㱑</a></li>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical77">English</option>
                                             <option value="bushu04006">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04006 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:19 GMT -->
