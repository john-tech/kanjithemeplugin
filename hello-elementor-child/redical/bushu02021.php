...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：几部（つくえ・きにょう・かぜかんむり・かぜがまえ・かざがまえ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>几部とは？</h2>
                              <p><strong>几部（きぶ）は、<span
                                             class="marker">台、机に関する字</span>が主に属します。</strong>「几」は「つくえ」「きにょう」と呼びます。</p>
                              <p>「⺇（かぜかんむり・かぜがまえ・かざがまえ）は、本来異なる意味を持つ別の部首ですが、形が似ているため同一の部首として扱うことが一般的です。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>几（かざがまえ）</option>
                                        <option value="bushu09005">風（かぜ）</option>
                                        <option value="#" selected>几（かぜかんむり・かぜがまえ）</option>
                                        ...
                                        <option value="#" selected>几（きにょう）</option>
                                        ...
                                        <option value="#" selected>几（つくえ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02021">漢検級順</a></li>
                                   <li><a href="cbushu02021">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：几部（つくえ・きにょう・かぜかんむり・かぜがまえ・かざがまえ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts02">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/24420">⺇</a></li>
                                        <li><a href="kanjiy/27759">𠘨</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts03">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12723">凢</a></li>
                                        <li><a href="kanjiy/24711">凣</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts04">
                                   <h3 class="ttl_while"><a href="kakusu04">４画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/13138">凤</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts12">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13139">凲</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts14">
                                   <h3 class="ttl_while"><a href="kakusu14">１４画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12728">凳</a></li>
                                        <li><a href="kanjiy/12730">凴</a></li>
                                   </ul>
                              </div>
                         </div><!--bushu_wrap-->
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical16">English</option>
                                             <option value="bushu02021">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu02021 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:35 GMT -->
