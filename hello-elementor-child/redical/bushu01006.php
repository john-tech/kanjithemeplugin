...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：丿部（の・はらいぼう）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>丿部とは？</h2>
                              <p>丿は、「右から左に曲がっていること」「左にはらうこと」などを表しますが、<strong>部首としての丿（丿部：へつぶ）は、<span
                                             class="marker">主に字形から文字を整理するために設けられたものであり、特定の意味は持たない</span>とされます。</strong>「丿」は「の」「はらいぼう」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>丿（の）</option>
                                        ...
                                        <option value="#" selected>丿（はらいぼう）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu01006">漢検級順</a></li>
                                   <li><a href="cbushu01006">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：丿部（の・はらいぼう）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts01">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="5703">丿</a></li>
                                        <li><a href="6613">乁</a></li>
                                        <li><a href="6614">乀</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts03">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13009">么</a></li>
                                        <li><a href="kanjiy/27665">乊</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12394">丢</a></li>
                                        <li><a href="kanjiy/27751">𠂢</a></li>
                                        <li><a href="kanjiy/27757">𠂤</a></li>
                                   </ul>
                              </div>
