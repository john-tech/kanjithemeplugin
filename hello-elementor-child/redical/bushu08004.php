...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：門部（もん・もんがまえ・かどがまえ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>門部とは？</h2>
                              <p><strong>門部（もんぶ）は、<span
                                             class="marker">門（もん）、出入り口などに関する字</span>が主に属します。</strong>「門」は「もん」、門は構えの形になることが多く、構えの形を「もんがまえ」「かどがまえ」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>門（かどがまえ）</option>
                                        ...
                                        <option value="#" selected>門（もん・もんがまえ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu08004">漢検級順</a></li>
                                   <li><a href="cbushu08004">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：門部（もん・もんがまえ・かどがまえ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical169">English</option>
                                             <option value="bushu08004">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu08004 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:35 GMT -->
