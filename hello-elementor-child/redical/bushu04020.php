...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：方部（ほう・ほうへん・かたへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>方部とは？</h2>
                              <p><strong>方部（ほうぶ）は、<span
                                             class="marker">旗（はた）の種類や状態などに関する字</span>が主に属します。</strong>「方」は「ほう」、偏になった形を「ほうへん」「かたへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>方（かたへん）</option>
                                        ...
                                        <option value="#" selected>方（ほう・ほうへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04020">漢検級順</a></li>
                                   <li><a href="cbushu04020">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：方部（ほう・ほうへん・かたへん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/19950">㫈</a></li>
                                        <li><a href="kanjiy/25355">旀</a></li>
                                        <li><a href="kanjiy/27186">㫆</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts10">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/19948">㫅</a></li>
                                        <li><a href="kanjiy/19949">㫇</a></li>
                                        <li><a href="kanjiy/27187">㫉</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts11">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/15080">旇</a></li>
                                        <li><a href="kanjiy/19951">㫊</a></li>
                                        <li><a href="kanjiy/19952">㫋</a></li>
                                        <li><a href="kanjiy/27188">㫌</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts13">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/15082">旓</a></li>
                                        <li><a href="kanjiy/15083">旕</a></li>
                                        <li><a href="kanjiy/19953">㫍</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts15">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/19954">㫎</a></li>
                                        <li><a href="kanjiy/19955">㫏</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical70">English</option>
                                             <option value="bushu04020">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04020 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:27 GMT -->
