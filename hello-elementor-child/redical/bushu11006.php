...
<body>
     <div id="all">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：鹿部（しか・しかへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>鹿部とは？</h2>
                              <p><strong>鹿部（ろくぶ）は、<span
                                             class="marker">鹿（しか）や鹿に似た動物などに関する字</span>が主に属します。</strong>「鹿」は「しか」、偏になった形を「しかへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu11006">漢検級順</a></li>
                                   <li><a href="cbushu11006">読み順</a></li>
                              </ul>
                              <ul class="search_menu2">
                                   ...
                                   <li><a href="#parts31">31画</a></li>
                                   <li><a href="#parts33">33画</a></li>
                              </ul>
                         </div><!--search_data-->
                        
                         <h2 class="left_border">部首：鹿部（しか・しかへん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts24">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a class="color2" href="2994">麟</a>
                                        </li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts28">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="7259">麢</a></li>
                                   </ul>
                              </div>
                         
                              <div class="parts_box" id="parts31">
                                   <h3 class="ttl_while"><a href="kakusu31">３１画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="18569">麣</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical198">English</option>
                                             <option value="bushu11006">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu11006 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:42:04 GMT -->
