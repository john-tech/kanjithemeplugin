...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：羊部（ひつじ・ひつじへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>羊部とは？</h2>
                              <p><strong>羊部（ようぶ）は、<span
                                             class="marker">羊や羊に似た動物などに関する字</span>が主に属します。</strong>「羊」は「ひつじ」、偏になった形を「ひつじへん」と呼びます。また、冠（かんむり）では「⺷」の形になります。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>羊 ⺷（ひつじ・ひつじへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06016">漢検級順</a></li>
                                   <li><a href="cbushu06016">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：羊部（ひつじ・ひつじへん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="24706">⺶</a></li>
                                        <li><a href="24707">⺷</a></li>
                                        <li><a href="27773">𦍌</a></li>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical123">English</option>
                                             <option value="bushu06016">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06016 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:07 GMT -->
