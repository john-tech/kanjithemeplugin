...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：弋部（しきがまえ・よく）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>弋部とは？</h2>
                              <p><strong>弋部（よくぶ）は、<span
                                             class="marker">杭（くい）に関する字</span>が主に属します。</strong>「弋」は式の上部であることから「しきがまえ」、また弋の字の音から「よく」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>弋（しきがまえ）</option>
                                        ...
                                        <option value="#" selected>弋（よく）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03026">漢検級順</a></li>
                                   <li><a href="cbushu03026">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：弋部（しきがまえ・よく）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts13">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14725">弒</a></li>
                                        <li><a href="kanjiy/19552">㢦</a></li>
                                   </ul>
                              </div>
                         </div><!--bushu_wrap-->
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical56">English</option>
                                             <option value="bushu03026">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03026 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:58 GMT -->
