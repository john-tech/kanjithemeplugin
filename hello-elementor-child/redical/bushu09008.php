...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：革部（かわへん・かくのかわ・つくりがわ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>革部とは？</h2>
                              <p><strong>革部（かくぶ）は、<span
                                             class="marker">革の状態、革製品などに関する字</span>が主に属します。</strong>「革」は「かくのかわ」「つくりがわ」、偏になった形を「かわへん」と呼んで、「<a
                                        href="bushu05015">皮（けがわ・ひのかわ）</a>」「<a
                                        href="bushu10007">韋（なめしがわ）</a>」と区別します。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>革（かくのかわ）</option>
                                        ...
                                        <option value="#" selected>革（かわへん）</option>
                                        ...
                                        <option value="#" selected>革（つくりがわ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu09008">漢検級順</a></li>
                                   <li><a href="cbushu09008">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：革部（かわへん・かくのかわ・つくりがわ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical177">English</option>
                                             <option value="bushu09008">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu09008 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:48 GMT -->
