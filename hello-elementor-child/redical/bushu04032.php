...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：爻部（こう・まじわる・めめ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>爻部とは？</h2>
                              <p><strong>爻部（こうぶ）は、主に字形から文字を整理するために設けられた部首であり、<span
                                             class="marker">「爻」の形を構成にした字</span>が属します。</strong></p>
                              <p>「爻」は「こう」「まじわる」、「メ」を二つ重ねたような形から「めめ」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>爻（こう）</option>
                                        ...
                                        <option value="#" selected>爻（まじわる）</option>
                                        ...
                                        <option value="#" selected>爻（めめ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04032">漢検級順</a></li>
                                   <li><a href="cbushu04032">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：爻部（こう・まじわる・めめ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical89">English</option>
                                             <option value="bushu04032">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04032 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:35 GMT -->
