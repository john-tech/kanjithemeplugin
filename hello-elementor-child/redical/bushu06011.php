...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：襾部（おおいかんむり・にし・かなめのかしら）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>襾部とは？</h2>
                              <p><strong>襾部（あぶ）は、<span
                                             class="marker">覆うことを表す字、「襾」「西」「覀」の形を構成にした字</span>が属します。</strong>「襾」「西」は「にし」、冠（かんむり）の形になることが多く、冠の形を「おおいかんむり」「かなめのかしら」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>襾 西 覀（おおいかんむり）</option>
                                        ...
                                        <option value="#" selected>襾 西 覀（かなめのかしら）</option>
                                        ...
                                        <option value="#" selected>襾 西 覀（にし）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06011">漢検級順</a></li>
                                   <li><a href="cbushu06011">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：襾部（おおいかんむり・にし・かなめのかしら）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical146">English</option>
                                             <option value="bushu06011">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06011 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:04 GMT -->
