...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：片部（かた・かたへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>片部とは？</h2>
                              <p><strong>片部（へんぶ）は、<span
                                             class="marker">板（特に木の板）に関する字</span>が主に属します。</strong>「片」は「かた」、偏になった形を「かたへん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04028">漢検級順</a></li>
                                   <li><a href="cbushu04028">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：片部（かた・かたへん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts08">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/20563">㸝</a></li>
                                        <li><a href="kanjiy/20564">㸞</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts09">
                                   <h3 class="ttl_while"><a href="kakusu09">９画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/16286">牉</a></li>
                                        <li><a href="kanjiy/16287">牊</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts10">
                                   <h3 class="ttl_while"><a href="kakusu10">１０画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/20565">㸟</a></li>
                                        <li><a href="kanjiy/20566">㸠</a></li>
                                        <li><a href="kanjiy/20567">㸡</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts13">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/16288">牏</a></li>
                                        <li><a href="kanjiy/16289">牑</a></li>
                                        <li><a href="kanjiy/24064">牐</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts14">
                                   <h3 class="ttl_while"><a href="kakusu14">１４画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/16290">牓</a></li>
                                        <li><a href="kanjiy/16291">牔</a></li>
                                        <li><a href="kanjiy/20568">㸢</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical91">English</option>
                                             <option value="bushu04028">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04028 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:33 GMT -->
