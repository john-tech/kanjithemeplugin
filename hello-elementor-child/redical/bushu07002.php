...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：見部（みる）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>見部とは？</h2>
                              <p><strong>見部（けんぶ）は、<span class="marker">目で見る行為に関する字</span>が主に属します。「見」は「みる」と呼びます。</strong>
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>見（みる）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu07002">漢検級順</a></li>
                                   <li><a href="cbushu07002">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：見部（みる）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical147">English</option>
                                             <option value="bushu07002">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu07002 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:18 GMT -->
