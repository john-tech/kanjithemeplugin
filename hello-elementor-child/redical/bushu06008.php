...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：行部（ぎょう・ぎょうがまえ・ゆきがまえ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>行部とは？</h2>
                              <p><strong>行部（こうぶ）は、<span
                                             class="marker">道路、街、歩行や進行などに関する字</span>が主に属します。</strong>「行」は「ぎょう」、行は構えの形になることが多く、構えの形を「ぎょうがまえ」「ゆきがまえ」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>行（ぎょう・ぎょうがまえ）</option>
                                        ...
                                        <option value="#" selected>行（ゆきがまえ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06008">漢検級順</a></li>
                                   <li><a href="cbushu06008">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：行部（ぎょう・ぎょうがまえ・ゆきがまえ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical144">English</option>
                                             <option value="bushu06008">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06008 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:02 GMT -->
