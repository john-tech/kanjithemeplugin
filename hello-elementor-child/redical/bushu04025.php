...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：戈部（ほこづくり・ほこがまえ・ほこ・かのほこ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>戈部とは？</h2>
                              <p>戈は先端がかぎ型になった武器の形にかたどり、<strong>戈部（かぶ）には<span
                                             class="marker">武器や武器を用いた行為などに関する字</span>が主に属します。</strong></p>
                              <p>「戈」は「ほこ」「かのほこ」、旁（つくり）になった形を「ほこづくり」、構えになった形を「ほこがまえ」と呼びます。「かのほこ」との呼び方は、「<a
                                        href="bushu05020">矛（ほこ・むのほこ）</a>」と区別するためのものです。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>戈（かのほこ）</option>
                                        ...
                                        <option value="#" selected>戈（ほこ）</option>
                                        <option value="bushu05020">矛（ほこ）</option>
                                        <option value="#" selected>戈（ほこがまえ）</option>
                                        <option value="bushu04023">殳（ほこづくり）</option>
                                        <option value="#" selected>戈（ほこづくり）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04025">漢検級順</a></li>
                                   <li><a href="cbushu04025">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：戈部（ほこづくり・ほこがまえ・ほこ・かのほこ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/24218">㦮</a></li>
                                        <li><a href="kanjiy/25260">戏</a></li>
                                        <li><a href="kanjiy/27768">𢦏</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts08">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12795">戗</a></li>
                                        <li><a href="kanjiy/19745">㦰</a></li>
                                        <li><a href="kanjiy/19746">㦱</a></li>
                                        <li><a href="kanjiy/19747">㦲</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts09">
                                   <h3 class="ttl_while"><a href="kakusu09">９画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14895">战</a></li>
                                        <li><a href="kanjiy/27127">㦳</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts10">
                                   <h3 class="ttl_while"><a href="kakusu10">１０画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/19748">㦴</a></li>
                                        <li><a href="kanjiy/19749">㦵</a></li>
                                        <li><a href="kanjiy/24219">㦶</a></li>
                                        <li><a href="kanjiy/25261">戙</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts13">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14896">戤</a></li>
                                        <li><a href="kanjiy/14897">戥</a></li>
                                        <li><a href="kanjiy/19751">㦹</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts14">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12794">戧</a></li>
                                        <li><a href="kanjiy/14898">戨</a></li>
                                        <li><a href="kanjiy/19752">㦺</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts15">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/19753">㦻</a></li>
                                        <li><a href="kanjiy/19754">㦼</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical62">English</option>
                                             <option value="bushu04025">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04025 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:31 GMT -->
