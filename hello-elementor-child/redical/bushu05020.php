...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：矛部（ほこ・ほこへん・むのほこ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>矛部とは？</h2>
                              <p><strong>矛部（ぼうぶ）は、<span class="marker">矛（ほこ）の種類や形状などに関する字</span>などが主に属します。</strong></p>
                              <p>「矛」は「ほこ」「むのほこ」、偏になった形を「ほこへん」と呼びます。「むのほこ」との呼び方は、「<a
                                        href="bushu04025">戈（ほこ・かのほこ）</a>」と区別するためのものです。</p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>矛（むのほこ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05020">漢検級順</a></li>
                                   <li><a href="cbushu05020">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：矛部（ほこ・ほこへん・むのほこ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical110">English</option>
                                             <option value="bushu05020">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05020 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:53 GMT -->
