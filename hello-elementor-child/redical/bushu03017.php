...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：夂・夊部（ふゆがしら・ち・すいにょう・なつあし）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>夂・夊部とは？</h2>
                              <p><strong>夂部（ちぶ）は、<span
                                             class="marker">上からくだる足の動きを表す字</span>が主に属します。</strong>「夂」は、「ふゆがしら」「ち」「ちにょう」と呼びます。
                              </p>
                              <p><strong>夊部（すいぶ）は、<span
                                             class="marker">足に関する字</span>が主に属します。</strong>「夊」は、「すいにょう」「なつあし」と呼びます。</p>
                              <p>「夂」と「夊」は元は別の部首ですが、常用漢字や人名用漢字ではすべて「夂」と書くことから同一のページで扱っています。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>夂 夊（すいにょう）</option>
                                        ...
                                        <option value="#" selected>夂 夊（ち）</option>
                                        ...
                                        <option value="#" selected>夂 夊（なつあし）</option>
                                        ...
                                        <option value="#" selected>夂 夊（ふゆがしら）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03017">漢検級順</a></li>
                                   <li><a href="cbushu03017">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：夂・夊部（ふゆがしら・ち・すいにょう・なつあし）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13895">夆</a></li>
                                        <li><a href="kanjiy/13898">夋</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13897">夈</a></li>
                                        <li><a href="kanjiy/13900">复</a></li>
                                        <li><a href="kanjiy/19103">㚅</a></li>
                                        <li><a href="kanjiy/19104">㚆</a></li>
                                        <li><a href="kanjiy/26818">㚇</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical34">English</option>
                                             <option value="bushu03017">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03017 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:50 GMT -->
