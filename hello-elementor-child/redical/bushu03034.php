...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：屮部（てつ・めばえ・くさのめ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>屮部とは？</h2>
                              <p>屮は草の芽生えを表しますが、<strong>屮部（てつぶ）は字形から文字を整理するために設けられた部首であり、<span
                                             class="marker">「屮」の形を構成にした字</span>が属します。</strong>「屮」は「てつ」「めばえ」「くさのめ」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>屮（くさのめ）</option>
                                        ...
                                        <option value="#" selected>屮（てつ）</option>
                                        ...
                                        <option value="#" selected>屮（めばえ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03034">漢検級順</a></li>
                                   <li><a href="cbushu03034">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：屮部（てつ・めばえ・くさのめ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14377">屰</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts07">
                                   <h3 class="ttl_while"><a href="kakusu07">７画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/19334">㞣</a></li>
                                        <li><a href="kanjiy/24208">㞷</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical45">English</option>
                                             <option value="bushu03034">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03034 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:09 GMT -->
