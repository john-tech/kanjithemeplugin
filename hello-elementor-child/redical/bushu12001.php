...
<body>
     <div id="all">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：齒・歯部（は・はへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>齒・歯部とは？</h2>
                              <p><strong>齒・歯部（しぶ）は、<span
                                             class="marker">歯の種類や状態、歯でかむことなどに関する字</span>が属します。</strong>「齒」「歯」は「は」、偏になった形を「はへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>齒 歯（は）</option>
                                        ...
                                        <option value="#" selected>齒 歯（はへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu12001">漢検級順</a></li>
                                   <li><a href="cbushu12001">読み順</a></li>
                              </ul>
                              <ul class="search_menu2">
                                   ...
                                   <li><a href="#parts35">35画</a></li>
                              </ul>
                         </div><!--search_data-->
                        
                         <h2 class="left_border">部首：齒・歯部（は・はへん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts26">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="23716">䶥</a></li>
                                        <li><a href="23717">䶦</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts27">
                                   <h3 class="ttl_while"><a href="kakusu27">２７画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="23718">䶧</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts28">
                                   <h3 class="ttl_while"><a href="kakusu28">２８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="6677">齽</a></li>
                                        <li><a href="6678">齼</a></li>
                                        <li><a href="23719">䶨</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts29">
                                   <h3 class="ttl_while"><a href="kakusu29">２９画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="23720">䶩</a></li>
                                        <li><a href="23721">䶪</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts35">
                                   <h3 class="ttl_while"><a href="kakusu35">３５画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="6520">齾</a></li>
                                        <li><a href="23722">䶫</a></li>
                                   </ul>
                              </div>
                         </div><!--bushu_wrap-->
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical211">English</option>
                                             <option value="bushu12001">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu12001 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:42:06 GMT -->
