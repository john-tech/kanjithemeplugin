...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：小部（しょう・しょうがしら・なおがしら）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>小部とは？</h2>
                              <p>小部（しょうぶ）は、<strong><span class="marker">ちいさい、少ない、細かいなどの意味を表す字</span>、<span
                                             class="marker">字の形に「⺌」を含む字</span>などが属します。</strong>「小」は「しょう」、「⺌」の形を「しょうがしら」「なおがしら」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>小（しょう・しょうがしら）</option>
                                        ...
                                        <option value="#" selected>小（なおがしら）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03008">漢検級順</a></li>
                                   <li><a href="cbushu03008">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：小部（しょう・しょうがしら・なおがしら）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts05">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14337">尔</a></li>
                                        <li><a href="kanjiy/25094">尕</a></li>
                                        <li><a href="kanjiy/26240">龸</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14338">尗</a></li>
                                        <li><a href="kanjiy/14339">尘</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts14">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/19300">㝺</a></li>
                                        <li><a href="kanjiy/25096">尡</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts15">
                                   <h3 class="ttl_while"><a href="kakusu15">１５画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/19301">㝻</a></li>
                                   </ul>
                              </div>
                         </div><!--bushu_wrap-->
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical42">English</option>
                                             <option value="bushu03008">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03008 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:43 GMT -->
