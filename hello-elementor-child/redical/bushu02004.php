...
div#sidebar {
    ...
    <div id="wrapper" class="cf">
        <div id="content">
            <h1 class="ttl_main">部首：十部（じゅう）の漢字</h1>

            <div class="bushu_about">
                <div class="bushu_about_box">
                    <h2>十部とは？</h2>
                    <p>十は、数の「じゅう」を表しますが、<strong>部首としての十（十部：じゅうぶ）は、<span
                                class="marker">主に字形から文字を整理するために設けられたものであり、特定の意味は持たない</span>とされます。</strong>「十」は「じゅう」と呼びます。
                    </p>
                </div>
            </div>
            <div class="parts_data">
                <div class="search_narrowdown">
                    ...
                    <div class="narrowdown_select">
                        <select name="select" onChange="location.href=value;" class="select1">
                            ...
                            <option value="#" selected>十（じゅう）</option>
                ...
                <div class="search_data bushu_menu">
                    <ul class="search_menu">
                        <li>画数順</li>
                        <li><a href="bbushu02004">漢検級順</a></li>
                        <li><a href="cbushu02004">読み順</a></li>
                    </ul>
                ...
                <h2 class="left_border">部首：十部（じゅう）の漢字一覧</h2>
                <div class="bushu_wrap">
                    ...
                    <div class="parts_box" id="parts02">
                        ...
                        <ul class="search_parts">
                            <li><a class="color1" href="kanji/034">十</a></li>
                        </ul>
                    </div>
                    <div class="parts_box" id="parts03">
                        ...
                        <ul class="search_parts">
                            ...
                            <li><a href="kanjiy/12996">卂</a></li>
                            <li><a href="kanjiy/12997">卄</a></li>
                        </ul>
                    </div>
                    <div class="parts_box" id="parts04">
                        ...
                        <ul class="search_parts">
                            ...
                            <li><a href="kanjiy/18844">㔹</a></li>
                            <li><a href="kanjiy/27785">𠥼</a></li>
                        </ul>
                    </div>
                    <div class="parts_box" id="parts05">
                        ...
                        <ul class="search_parts">
                            ...
                            <li><a href="kanjiy/12999">卌</a></li>
                            <li><a href="kanjiy/24202">㚈</a></li>
                            <li><a href="kanjiy/24392">㔺</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="parts_box" id="parts06">
                        ...
                        <ul class="search_parts">
                            ...
                            <li><a href="kanjiy/13170">卐</a></li>
                            <li><a href="kanjiy/18845">㔻</a></li>
                        </ul>
                    </div>
                    <div class="parts_box" id="parts08">
                        ...
                        <ul class="search_parts">
                            ...
                            <li><a href="kanjiy/24737">单</a></li>
                            <li><a href="kanjiy/26241">龺</a></li>
                            <li><a href="kanjiy/27736">𠦚</a></li>
                            <li><a href="kanjiy/27765">𠦝</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="side_box">
                        ...
                        <div class="ChangeElem_Panel2">
                            <ul class="side_rank sr_01">
                                ...
                                <li><a href="kanjiy/12934" title="漢字「殺」のページ"><span class="rank">10</span><span
