...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：面部（めん・おもて）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>面部とは？</h2>
                              <p><strong>面部（めんぶ）は、<span
                                             class="marker">顔面、顔の状態などに関する字</span>が主に属します。</strong>「面」は「めん」「おもて」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>面（おもて）</option>
                                        ...
                                        <option value="#" selected>面（めん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu09006">漢検級順</a></li>
                                   <li><a href="cbushu09006">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：面部（めん・おもて）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical176">English</option>
                                             <option value="bushu09006">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu09006 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:45 GMT -->
