...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：网部（あみがしら・あみめ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>网部とは？</h2>
                              <p><strong>网部（もうぶ）は、<span
                                             class="marker">網（あみ）の種類や、網にかけて捕らえることなどに関する字</span>が主に属します。</strong></p>
                              <p>「网」「罒」は「あみがしら」「あみめ」と呼びます。<a
                                        href="bushu05007">目（め）</a>の変化した形の「罒」は、「あみがしら」「あみめ」とは異なるのものですが、形に差はありません。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>网 罒 㓁（あみがしら・あみめ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06018">漢検級順</a></li>
                                   <li><a href="cbushu06018">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：网部（あみがしら・あみめ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts04">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="9169">罓</a></li>
                                        <li><a href="9170">㓁</a></li>
                              ...
                              <div class="parts_box" id="parts05">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="9168">罒</a></li>
                                        <li><a href="21654">䍏</a></li>
                                        <li><a href="27771">𦉰</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical122">English</option>
                                             <option value="bushu06018">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06018 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:40 GMT -->
