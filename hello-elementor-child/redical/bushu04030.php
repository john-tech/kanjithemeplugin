...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：爪部（つめ・つめかんむり・つめがしら・そうにょう・のつ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>爪部とは？</h2>
                              <p><strong>爪部（そうぶ）は、<span
                                             class="marker">爪や手でつかむこと</span>に関する字が主に属します。</strong>「爪」は「つめ」、また「ノ」と「ツ」を組み合わたような形から「のつ」、冠（かんむり）になった形「爫」を「つめかんむり」「つめがしら」、繞（にょう）になった形を「そうにょう」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>爪 爫（そうにょう）</option>
                                        ...
                                        <option value="#" selected>爪 爫（つめ・つめかんむり・つめがしら）</option>
                                        ...
                                        <option value="#" selected>爪 爫（のつ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04030">漢検級順</a></li>
                                   <li><a href="cbushu04030">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：爪部（つめ・つめかんむり・つめがしら・そうにょう・のつ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts04">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/16276">爫</a></li>
                                        <li><a href="kanjiy/24612">⺤</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/16277">爮</a></li>
                                        <li><a href="kanjiy/16278">爯</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts14">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/20555">㸕</a></li>
                                        <li><a href="kanjiy/25672">爳</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical87">English</option>
                                             <option value="bushu04030">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04030 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:34 GMT -->
