...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：甘部（あまい・かん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>甘部とは？</h2>
                              <p><strong>甘部（かんぶ）は、<span
                                             class="marker">あまい、おいしいなどの意味を持つ字</span>が主に属します。</strong>「甘」は「あまい」「かん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>甘（あまい）</option>
                                        ...
                                        <option value="#" selected>甘（かん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05019">漢検級順</a></li>
                                   <li><a href="cbushu05019">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：甘部（あまい・かん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical99">English</option>
                                             <option value="bushu05019">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05019 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:52 GMT -->
