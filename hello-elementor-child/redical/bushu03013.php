...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：干部（かん・いちじゅう・ほす）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>干部とは？</h2>
                              <p><strong>干部（かんぶ）は、主に字形から文字を整理するために設けられた部首であり、<span
                                             class="marker">「干」の形を構成にした字</span>が属します。</strong></p>
                              <p>「干」は「かん」「いちじゅう」「ほす」と呼びます。「いちじゅう」は、「一」と「十」を組み合わせた形からきた呼び方です。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>干（いちじゅう）</option>
                                        ...
                                        <option value="#" selected>干（かん）</option>
                                        ...
                                        <option value="#" selected>干（ほす）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03013">漢検級順</a></li>
                                   <li><a href="cbushu03013">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：干部（かん・いちじゅう・ほす）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical51">English</option>
                                             <option value="bushu03013">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03013 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:47 GMT -->
