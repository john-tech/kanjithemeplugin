...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：雨部（あめ・あめかんむり・あまかんむり）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>雨部とは？</h2>
                              <p><strong>雨部（うぶ）は、<span
                                             class="marker">雨、雪、雷など、気象現象に関する字</span>が主に属します。</strong>「雨」は「あめ」、雨は冠（かんむり）の形になることが多く、冠の形を「あめかんむり」「あまかんむり」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>雨（あまかんむり）</option>
                                        <option value="bushu06018">网 罒 㓁（あみがしら・あみめ）</option>
                                        <option value="#" selected>雨（あめ・あめかんむり）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu08001">漢検級順</a></li>
                                   <li><a href="cbushu08001">読み順</a></li>
                              </ul>
                              <ul class="search_menu2">
                                   ...
                                   <li><a href="#parts39">39画</a></li>
                                   <li><a href="#parts48">48画</a></li>
                                   <li><a href="#parts52">52画</a></li>
                              </ul>
                         </div><!--search_data-->
                        
                         <h2 class="left_border">部首：雨部（あめ・あめかんむり・あまかんむり）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts29">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="18247">靏</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts36">
                                   <h3 class="ttl_while"><a href="kakusu36">３６画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="23049">䨺</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts39">
                                   <h3 class="ttl_while"><a href="kakusu39">３９画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="18248">靐</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts48">
                                   <h3 class="ttl_while"><a href="kakusu48">４８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="27881">𩇔</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts52">
                                   <h3 class="ttl_while"><a href="kakusu52">５２画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="23050">䨻</a></li>
                                   </ul>
                              </div>
                         </div><!--bushu_wrap-->
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical173">English</option>
                                             <option value="bushu08001">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu08001 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:31 GMT -->
