...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：瓜部（うり）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>瓜部とは？</h2>
                              <p><strong>瓜部（かぶ）は、<span
                                             class="marker">瓜（うり）に関する字</span>が主に属します。</strong>「瓜」は「うり」と呼びます。瓜の画数は、「常用漢字・人名用漢字」の構成などでは６画ですが、「康煕（こうき）字典」では<a
                                        href="2210">漢字の瓜のページ</a>の異体字欄の字体のように「ム」を２画、総画数を５画と数えます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>瓜（うり）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06028">漢検級順</a></li>
                                   <li><a href="cbushu06028">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：瓜部（うり）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical97">English</option>
                                             <option value="bushu06028">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06028 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:56 GMT -->
