...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：文部（ぶん・ぶんにょう）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>文部とは？</h2>
                              <p><strong>文部（ぶんぶ）は、<span
                                             class="marker">あや、彩り、飾り、模様などの意味を持つ字</span>が主に属します。</strong>「文」は「ぶん」、繞（脚）になった形を「ぶんにょう」と呼びます。また、「ふみづくり」と呼ぶこともあります。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>文（ぶん・ぶんにょう）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04009">漢検級順</a></li>
                                   <li><a href="cbushu04009">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：文部（ぶん・ぶんにょう）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts11">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/15073">斍</a></li>
                                        <li><a href="kanjiy/25354">斏</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical67">English</option>
                                             <option value="bushu04009">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04009 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:20 GMT -->
