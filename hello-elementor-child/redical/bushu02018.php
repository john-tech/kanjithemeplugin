...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：冖部（わかんむり・ひらかんむり・べきかんむり）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>冖部とは？</h2>
                              <p><strong>冖部（べきぶ）は、主に字形から文字を整理するために設けられた部首であり、<span
                                             class="marker">「冖」の形を構成にした字</span>が属します。</strong></p>
                              <p>「冖」はカタカナのワに形が似ていることから「わかんむり」、その他では「ひらかんむり」「べきかんむり」などと呼びます。</p>
                              <p>冝・宜や冨・富など、一部の字では「冖」と「<a href="bushu03016">宀（うかんむり）</a>」の両方で通用することがあります。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>冖（ひらかんむり）</option>
                                        ...
                                        <option value="#" selected>冖（べきかんむり）</option>
                                        ...
                                        <option value="#" selected>冖（わかんむり）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02018">漢検級順</a></li>
                                   <li><a href="cbushu02018">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：冖部（わかんむり・ひらかんむり・べきかんむり）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts04">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12702">冘</a></li>
                                        <li><a href="kanjiy/26481">㓀</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/18623">冝</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts08">
                                   <h3 class="ttl_while"><a href="kakusu08">８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12704">罙</a></li>
                                        <li><a href="kanjiy/12705">冞</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13123">冟</a></li>
                                        <li><a href="kanjiy/18763">㓂</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts10">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12706">冡</a></li>
                                        <li><a href="kanjiy/24702">冧</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical14">English</option>
                                             <option value="bushu02018">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu02018 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:33 GMT -->
