...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：臼部（うす）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>臼部とは？</h2>
                              <p><strong>臼部（きゅうぶ）は、<span
                                             class="marker">臼（うす）に関する字、また「&#x26951;（きょく）」をもとに両手で持ち上げることに関する字</span>が主に属します。</strong>「臼」は「うす」と呼びます。
                              </p>
                              <p>「臼（きゅう）」と「&#x26951;（きょく）」は別の字ですが、形が似ているため同一の部首として扱うことが一般的です。</p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>臼（うす）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06021">漢検級順</a></li>
                                   <li><a href="cbushu06021">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：臼部（うす）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical134">English</option>
                                             <option value="bushu06021">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06021 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:10 GMT -->
