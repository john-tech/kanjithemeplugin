...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：殳部（ほこづくり・るまた）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>殳部とは？</h2>
                              <p><strong>殳部（しゅぶ）は、<span
                                             class="marker">打つこと、たたくことなどに関する字</span>が主に属します。</strong>「殳」は「ほこづくり」、また「ル」と「又」を組み合わせたような形から「るまた」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>殳（ほこづくり）</option>
                                        ...
                                        <option value="#" selected>殳（るまた）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04023">漢検級順</a></li>
                                   <li><a href="cbushu04023">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：殳部（ほこづくり・るまた）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts10">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12931">㱾</a></li>
                                        <li><a href="kanjiy/12932">㱿</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts11">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12934">殺</a></li>
                                        <li><a href="kanjiy/12935">殹</a></li>
                                        <li><a href="kanjiy/12937">殸</a></li>
                                        <li><a href="kanjiy/20254">㲀</a></li>
                                        <li><a href="kanjiy/27875">𣪘</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts12">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12938">殽</a></li>
                                        <li><a href="kanjiy/20255">㲁</a></li>
                                        <li><a href="kanjiy/20256">㲂</a></li>
                                        <li><a href="kanjiy/20257">㲃</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts13">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12940">毁</a></li>
                                        <li><a href="kanjiy/12941">殾</a></li>
                                        <li><a href="kanjiy/20258">㲄</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts14">
                                   <h3 class="ttl_while"><a href="kakusu14">１４画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12942">毃</a></li>
                                        <li><a href="kanjiy/12945">毄</a></li>
                                        <li><a href="kanjiy/20259">㲅</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts16">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12956">毇</a></li>
                                        <li><a href="kanjiy/12958">毈</a></li>
                                        <li><a href="kanjiy/20260">㲆</a></li>
                                        <li><a href="kanjiy/20261">㲇</a></li>
                                        <li><a href="kanjiy/20262">㲈</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts17">
                                   <h3 class="ttl_while"><a href="kakusu17">１７画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/20263">㲉</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts18">
                                   <h3 class="ttl_while"><a href="kakusu18">１８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12955">毉</a></li>
                                        <li><a href="kanjiy/24240">㲊</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical79">English</option>
                                             <option value="bushu04023">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04023 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:29 GMT -->
