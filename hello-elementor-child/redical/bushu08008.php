...
?>
  ...
  <div class="contents_bnr link_sp">
    ...
    <div id="wrapper" class="cf">
      <div id="content">
        <h1 class="ttl_main">部首：隶部（たい・れいづくり）の漢字</h1>

        <div class="bushu_about">
          <div class="bushu_about_box">
            <h2>隶部とは？</h2>
            <p><strong>隶部（たいぶ）は、<span class="marker">「隶」の形を構成にした字</span>が属します。</strong>「隶」は「たい」「れいづくり」と呼びます。</p>
            <p></p>
          </div>
        </div>
        <div class="parts_data">
          <div class="search_narrowdown">
            ...
            <div class="narrowdown_select">
              <select name="select" onChange="location.href=value;" class="select1">
                ...
                <option value="#" selected>隶（たい）</option>
                ...
                <option value="#" selected>隶（れいづくり）</option>
          ...
          <div class="search_data bushu_menu">
            <ul class="search_menu">
              <li>画数順</li>
              <li><a href="bbushu08008">漢検級順</a></li>
              <li><a href="cbushu08008">読み順</a></li>
            </ul>
          ...
          <h2 class="left_border">部首：隶部（たい・れいづくり）の漢字一覧</h2>
          <div class="bushu_wrap">
            ...
            <div class="parts_box" id="parts16">
              ...
              <ul class="search_parts">
                <li><a class="color1" href="1308">隷</a></li>
              </ul>
            </div>
            ...
            <div class="language_footer">
              <div class="lan_inner">
                <select name="select" onChange="location.href=value;" tabindex="0">
                  ...
                  <option value="radical171">English</option>
                  <option value="bushu08008">Japanese</option>
                </select>
              </div>
            </div>
          </div>
...
<!-- Mirrored from bushu08008 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:40 GMT -->
