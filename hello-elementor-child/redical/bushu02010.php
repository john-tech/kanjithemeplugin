...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：亠部（なべぶた・けいさんかんむり）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>亠部とは？</h2>
                              <p><strong>亠部（とうぶ）は、主に字形から文字を整理するために設けられた部首であり、<span
                                             class="marker">「亠」の形を構成にした字</span>が属します。</strong></p>
                              <p>「亠」は、鍋の蓋の形に似ていることから「なべぶた」、易の卦算（文鎮）の形に似ていることから「けいさんかんむり」と呼びます。また、「てんいち」と呼ぶこともあります。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>亠（けいさんかんむり）</option>
                                        ...
                                        <option value="#" selected>亠（なべぶた）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02010">漢検級順</a></li>
                                   <li><a href="cbushu02010">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：亠部（なべぶた・けいさんかんむり）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/18674">㐫</a></li>
                                        <li><a href="kanjiy/24182">㐪</a></li>
                                        <li><a href="kanjiy/24547">产</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/24183">㐬</a></li>
                                        <li><a href="kanjiy/24548">亩</a></li>
                                        <li><a href="kanjiy/24550">亪</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13033">亱</a></li>
                                        <li><a href="kanjiy/13034">亲</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts12">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/13035">亴</a></li>
                                        <li><a href="kanjiy/24552">亵</a></li>
                                   </ul>
                              </div>
