...
<body>
     <div id="all">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：龍・竜部（りゅう・たつ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>龍・竜部とは？</h2>
                              <p><strong>龍・竜部（りゅうぶ）は、<span class="marker">竜に関する字</span>が属します。</strong>「龍」「竜」は「りゅう」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>龍 竜（たつ）</option>
                                        ...
                                        <option value="#" selected>龍 竜（りゅう）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu16001">漢検級順</a></li>
                                   <li><a href="cbushu16001">読み順</a></li>
                              </ul>
                              <ul class="search_menu2">
                                   ...
                                   <li><a href="#parts48">48画</a></li>
                              </ul>
                         </div><!--search_data-->
                        
                         <h2 class="left_border">部首：龍・竜部（りゅう・たつ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts48">
                                   <h3 class="ttl_while"><a href="kakusu48">４８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="24179">龘</a></li>
                                   </ul>
                              </div>
                         </div><!--bushu_wrap-->
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical212">English</option>
                                             <option value="bushu16001">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu16001 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:42:00 GMT -->
