...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：走部（はしる・そうにょう）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>走部とは？</h2>
                              <p><strong>走部（そうぶ）は、<span
                                             class="marker">走ること、歩くこと、行くことなどに関する字</span>が主に属します。</strong>「走」は「はしる」、繞（にょう）になった形を「そうにょう」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>走（そうにょう）</option>
                                        ...
                                        <option value="#" selected>走（はしる）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu07009">漢検級順</a></li>
                                   <li><a href="cbushu07009">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：走部（はしる・そうにょう）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical156">English</option>
                                             <option value="bushu07009">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu07009 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:24 GMT -->
