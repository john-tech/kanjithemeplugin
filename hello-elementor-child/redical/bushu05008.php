...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：立部（たつ・たつへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>立部とは？</h2>
                              <p><strong>立部（りゅうぶ）は、<span
                                             class="marker">立つこと、立つ動作などに関する字</span>が主に属します。</strong>「立」は「たつ」、偏になった形を「たつへん」と呼びます。
                              </p>
                              <p>立は日本ではリットル（容量の単位）の意味を持つことから、容量の単位に関する国字の偏に用いられます。例：「<a
                                        href="5537">竍</a>」「<a
                                        href="5538">竏</a>」「<a
                                        href="5539">竓</a>」「<a
                                        href="5540">竕</a>」「<a
                    ...
                    <div class="parts_data">
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05008">漢検級順</a></li>
                                   <li><a href="cbushu05008">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：立部（たつ・たつへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical117">English</option>
                                             <option value="bushu05008">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05008 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:45 GMT -->
