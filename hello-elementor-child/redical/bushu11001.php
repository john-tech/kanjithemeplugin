...
"@type":"BreadcrumbList",
"itemListElement":[
{ "@type":"ListItem", "position":1, "item":{ "@id":"", "name":"漢字辞典" } }, 
{ "@type":"ListItem", "position":2, "item":{ "@id":"cat/bushu", "name":"部首検索" } }, 
{ "@type":"ListItem", "position":3, "item":{ "@id":"cat/bushu10007", "name":"部首なめしがわ（韋）の漢字" } }
]},
{"@context": "http://schema.org",
"@type": "Article",
"mainEntityOfPage": {
...
"@type": "PropertyValue",
"name": "漢字",
"value": ["韋","韌","䪏","韎","韍","䪐","䪑","䪒","䪓","韑","韐","韏","韒","䪔","韓","韔","韕","䪕","韙","韗","䪗","韘","韖","韚","䪖","䪘","韜","韝","韞","韛","韡","䪙","䪚","韟","韠","韢","䪛","䪝","韣","䪜","韤","韥"]}
]
}
]
</script>
...
<body>
     <div id="all">
                    ...
                    <div class="center">
                         <div class="header_logo">
                              <div class="logo"><a href=""><img
                                             src="images/top-logo.svg" alt="漢字辞典"></a></div>
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：魚部（うお・うおへん・さかなへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>魚部とは？</h2>
                              <p><strong>魚部（ぎょぶ）は、<span
                                             class="marker">魚を中心とした水中に生息する生き物に関する字</span>が主に属します。</strong>「魚」は「うお」、偏になった形を「うおへん」「さかなへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>魚（うお・うおへん）</option>
                                        ...
                                        <option value="#" selected>魚（さかなへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu11001">漢検級順</a></li>
                                   <li><a href="cbushu11001">読み順</a></li>
                              </ul>
                              <ul class="search_menu2">
                                   ...
                                   <li><a href="#parts30">30画</a></li>
                                   <li><a href="#parts33">33画</a></li>
                                   <li><a href="#parts44">44画</a></li>
                              </ul>
                         </div><!--search_data-->
                        
                         <h2 class="left_border">部首：魚部（うお・うおへん・さかなへん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts24">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a class="color2" href="2993">鱗</a>
                                        </li>
                              ...
                              <div class="parts_box" id="parts26">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="23520">䲙</a></li>
                                        <li><a href="6936">䲛</a></li>
                                        <li><a href="7077">鱵</a></li>
                                        <li><a href="7079">鱲</a></li>
                                        <li><a href="18459">鱳</a></li>
                                        <li><a href="3897">鱶</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts27">
                                   <h3 class="ttl_while"><a href="kakusu27">２７画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="23521">䲚</a></li>
                                        <li><a href="7080">鱷</a></li>
                                        <li><a href="3898">鱸</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts28">
                                   <h3 class="ttl_while"><a href="kakusu28">２８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="18460">鱹</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts30">
                                   <h3 class="ttl_while"><a href="kakusu30">３０画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="7082">鱺</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts33">
                                   <h3 class="ttl_while"><a href="kakusu33">３３画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="7083">鱻</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts44">
                                   <h3 class="ttl_while"><a href="kakusu44">４４画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="23522">䲜</a></li>
                                   </ul>
                              </div>
                         </div><!--bushu_wrap-->
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical195">English</option>
                                             <option value="bushu11001">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu11001 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:42:01 GMT -->
