...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：生部（いきる・うまれる）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>生部とは？</h2>
                              <p><strong>生部（せいぶ）は、<span
                                             class="marker">生まれること、生きること、生命などに関する字</span>が主に属します。</strong>「生」は「いきる」「うまれる」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>生（いきる）</option>
                                        ...
                                        <option value="#" selected>生（うまれる）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05003">漢検級順</a></li>
                                   <li><a href="cbushu05003">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：生部（いきる・うまれる）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical100">English</option>
                                             <option value="bushu05003">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05003 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:42 GMT -->
