...
?>
  ...
  <div class="contents_bnr link_sp">
    ...
    <div id="wrapper" class="cf">
      <div id="content">
        <h1 class="ttl_main">部首：牙部（きば・きばへん）の漢字</h1>

        <div class="bushu_about">
          <div class="bushu_about_box">
            <h2>牙部とは？</h2>
            <p><strong>牙部（がぶ）は、<span class="marker">牙（きば）や歯に関する字</span>が主に属します。</strong>「牙」は「きば」、偏になった形を「きばへん」と呼びます。</p>
          </div>
        </div>
        <div class="parts_data">
          <div class="search_narrowdown">
            ...
            <div class="narrowdown_select">
              <select name="select" onChange="location.href=value;" class="select1">
                ...
                <option value="#" selected>牙（きば・きばへん）</option>
          ...
          <div class="search_data bushu_menu">
            <ul class="search_menu">
              <li>画数順</li>
              <li><a href="bbushu04031">漢検級順</a></li>
              <li><a href="cbushu04031">読み順</a></li>
            </ul>
          ...
          <h2 class="left_border">部首：牙部（きば・きばへん）の漢字一覧</h2>
            ...
            <div class="language_footer">
              <div class="lan_inner">
                <select name="select" onChange="location.href=value;" tabindex="0">
                  ...
                  <option value="radical92">English</option>
                  <option value="bushu04031">Japanese</option>
                </select>
              </div>
            </div>
          </div>
...
<!-- Mirrored from bushu04031 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:35 GMT -->
