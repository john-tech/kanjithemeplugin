...
?>
  ...
  <div class="contents_bnr link_sp">
    ...
    <div id="wrapper" class="cf">
      <div id="content">
        <h1 class="ttl_main">部首：鬯部（ちょう・においざけ）の漢字</h1>

        <div class="bushu_about">
          <div class="bushu_about_box">
            <h2>鬯部とは？</h2>
            <p><strong>鬯部（ちょうぶ）は、<span
                  class="marker">香酒（香料入りの酒）に関する字、「鬯」の形を構成にした字</span>などが属します。</strong>「鬯」は「ちょう」「においざけ」と呼びます。</p>
            <p></p>
          </div>
        </div>
        <div class="parts_data">
          <div class="search_narrowdown">
            ...
            <div class="narrowdown_select">
              <select name="select" onChange="location.href=value;" class="select1">
                ...
                <option value="#" selected>鬯（ちょう）</option>
                ...
                <option value="#" selected>鬯（においざけ）</option>
          ...
          <div class="search_data bushu_menu">
            <ul class="search_menu">
              <li>画数順</li>
              <li><a href="bbushu10006">漢検級順</a></li>
              <li><a href="cbushu10006">読み順</a></li>
            </ul>
          ...
          <h2 class="left_border">部首：鬯部（ちょう・においざけ）の漢字一覧</h2>
          <div class="bushu_wrap">
            ...
            <div class="parts_box" id="parts29">
              ...
              <ul class="search_parts">
                <li><a class="color1" href="1950">鬱</a></li>
              </ul>
            </div>
          </div><!--bushu_wrap-->
            ...
            <div class="language_footer">
              <div class="lan_inner">
                <select name="select" onChange="location.href=value;" tabindex="0">
                  ...
                  <option value="radical192">English</option>
                  <option value="bushu10006">Japanese</option>
                </select>
              </div>
            </div>
          </div>
...
<!-- Mirrored from bushu10006 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:58 GMT -->
