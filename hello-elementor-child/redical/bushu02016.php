...
div#sidebar {
    display: none;
     ...
     <div id="wrapper" class="cf">
          <div id="content">
               <h1 class="ttl_main">部首：匸部（かくしがまえ）の漢字</h1>

               <div class="bushu_about">
                    <div class="bushu_about_box">
                         <h2>匸部とは？</h2>
                         <p><strong>匸部（けいぶ）は、<span class="marker">物を隠す、物を隠す場所などに関する字</span>が主に属します。</strong>「匸」は「かくしがまえ」と呼びます。
                         </p>
                         <p>「匸（かくしがまえ）」と「<a href="bushu02023">匚（はこがまえ）</a>」は別の部首ですが、常用漢字においては区別しないこともあります。</p>
                    </div>
               </div>
               <div class="parts_data">
                    <div class="search_narrowdown">
                         ...
                         <div class="narrowdown_select">
                              <select name="select" onChange="location.href=value;" class="select1">
                                   ...
                                   <option value="#" selected>匸（かくしがまえ）</option>
                    ...
                    <div class="search_data bushu_menu">
                         <ul class="search_menu">
                              <li>画数順</li>
                              <li><a href="bbushu02016">漢検級順</a></li>
                              <li><a href="cbushu02016">読み順</a></li>
                         </ul>
                    ...
                    <h2 class="left_border">部首：匸部（かくしがまえ）の漢字一覧</h2>
                         ...
                         <div class="language_footer">
                              <div class="lan_inner">
                                   <select name="select" onChange="location.href=value;" tabindex="0">
                                        ...
                                        <option value="radical23">English</option>
                                        <option value="bushu02016">Japanese</option>
                                   </select>
                              </div>
                         </div>
                    </div>
...
<!-- Mirrored from bushu02016 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:31 GMT -->
