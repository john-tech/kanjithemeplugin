...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：鬼部（おに・きにょう）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>鬼部とは？</h2>
                              <p><strong>鬼部（きぶ）は、<span
                                             class="marker">霊魂、精霊、神秘的な現象などに関する字</span>が主に属します。</strong>「鬼」は「おに」、繞（にょう）になった形を「きにょう」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>鬼（おに）</option>
                                        ...
                                        <option value="#" selected>鬼（きにょう）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu10004">漢検級順</a></li>
                                   <li><a href="cbushu10004">読み順</a></li>
                              </ul>
                              <ul class="search_menu2">
                                   ...
                                   <li><a href="#parts34">34画</a></li>
                              </ul>
                         </div><!--search_data-->
                        
                         <h2 class="left_border">部首：鬼部（おに・きにょう）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts34">
                                   <h3 class="ttl_while"><a href="kakusu34">３４画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="23457">䰱</a></li>
                                   </ul>
                              </div>
                         </div><!--bushu_wrap-->
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical194">English</option>
                                             <option value="bushu10004">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu10004 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:57 GMT -->
