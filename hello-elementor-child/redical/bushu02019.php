...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：卩部（ふしづくり・わりふ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>卩部とは？</h2>
                              <p>卩は、人がひざまずく形や割り符の形にかたどり、<strong>卩部（せつぶ）は、<span
                                             class="marker">ひざまずく動作やしるしの意味を持つ字、「卩」の形を構成にした字</span>などが属します。</strong>「卩」は「ふしづくり」「わりふ」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>卩 㔾（ふしづくり）</option>
                                        ...
                                        <option value="#" selected>卩 㔾（わりふ）</option>
                                   </select>
                              </div>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02019">漢検級順</a></li>
                                   <li><a href="cbushu02019">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：卩部（ふしづくり・わりふ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts02">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/18848">㔾</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts03">
                                   <h3 class="ttl_while"><a href="kakusu03">３画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/13175">卪</a></li>
                                        <li><a href="kanjiy/18849">㔿</a></li>
                                        <li><a href="kanjiy/24740">卫</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts04">
                                   <h3 class="ttl_while"><a href="kakusu04">４画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/13176">卬</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13177">卲</a></li>
                                        <li><a href="kanjiy/26500">㕀</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts08">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13178">卶</a></li>
                                        <li><a href="kanjiy/13179">卺</a></li>
                                        <li><a href="kanjiy/18850">㕁</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical26">English</option>
                                             <option value="bushu02019">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu02019 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:33 GMT -->
