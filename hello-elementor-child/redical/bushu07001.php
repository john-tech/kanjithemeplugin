...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：貝部（かい・かいへん・こがい）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>貝部とは？</h2>
                              <p><strong>貝部（ばいぶ）は、<span
                                             class="marker">貨幣や財貨、それに関連する行為などに関する字</span>が主に属します。</strong>「貝」は「かい」「こがい」、偏になった形を「かいへん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>貝（かい・かいへん）</option>
                                        ...
                                        <option value="#" selected>貝（こがい）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu07001">漢検級順</a></li>
                                   <li><a href="cbushu07001">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：貝部（かい・かいへん・こがい）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical154">English</option>
                                             <option value="bushu07001">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu07001 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:17 GMT -->
