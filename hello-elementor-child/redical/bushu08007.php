...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：非部（あらず・ひ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>非部とは？</h2>
                              <p><strong>非部（ひぶ）は、<span
                                             class="marker">そむく、たがうなどの意味を持つ字、「非」の形を構成にした字</span>などが属します。</strong>「非」は「あらず」「ひ」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>非（あらず）</option>
                                        ...
                                        <option value="#" selected>非（ひ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu08007">漢検級順</a></li>
                                   <li><a href="cbushu08007">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：非部（あらず・ひ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical175">English</option>
                                             <option value="bushu08007">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu08007 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:39 GMT -->
