...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：幺部（いとがしら・よう）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>幺部とは？</h2>
                              <p><strong>幺部（ようぶ）は、<span
                                             class="marker">小さいこと、細かいこと、かすかなことなどを表す字</span>が主に属します。</strong>「幺」は、「いとがしら」「よう」と呼びます。また、「いとのうえ」「おさなへん」などと呼ぶこともあります。
                              </p>
                              <p>「糸」の上部の形であることから、「いとがしら」「いとのうえ」と呼ぶようになったと言われています。</p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>幺（いとがしら）</option>
                                        ...
                                        <option value="#" selected>幺（よう）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03033">漢検級順</a></li>
                                   <li><a href="cbushu03033">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：幺部（いとがしら・よう）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts12">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/19503">㡫</a></li>
                                        <li><a href="kanjiy/19504">㡬</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical52">English</option>
                                             <option value="bushu03033">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03033 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:08 GMT -->
