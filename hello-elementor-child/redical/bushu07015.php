...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：辛部（しん・からい）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>辛部とは？</h2>
                              <p><strong>辛部（しんぶ）は、<span
                                             class="marker">罪または罪を裁くことに関する字、味がからいことを表す字</span>などが主に属します。</strong>「辛」は「しん」「からい」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>辛（からい）</option>
                                        ...
                                        <option value="#" selected>辛（しん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu07015">漢検級順</a></li>
                                   <li><a href="cbushu07015">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：辛部（しん・からい）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical160">English</option>
                                             <option value="bushu07015">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu07015 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:28 GMT -->
