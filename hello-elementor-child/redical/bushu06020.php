...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：耒部（らいすき・すきへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>耒部とは？</h2>
                              <p><strong>耒部（らいぶ）は、<span
                                             class="marker">農具（特にすき）や耕作に関する字</span>が主に属します。</strong>「耒」は「らいすき」、偏になった形を「すきへん」と呼びます。その他では、「すき」「らいへん」などと呼ぶこともあります。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>耒（すきへん）</option>
                                        ...
                                        <option value="#" selected>耒（らいすき）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06020">漢検級順</a></li>
                                   <li><a href="cbushu06020">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：耒部（らいすき・すきへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical127">English</option>
                                             <option value="bushu06020">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06020 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:09 GMT -->
