...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：艮部（うしとら・こん・こんづくり・ねづくり）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>艮部とは？</h2>
                              <p><strong>艮部（ごんぶ）は、主に字形から文字を整理するために設けられた部首であり、<span
                                             class="marker">「艮」の形を構成にした字</span>が属します。</strong>「艮」は「こん」「うしとら」、旁（つくり）になった形を「こんづくり」「ねづくり」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>艮（うしとら）</option>
                                        ...
                                        <option value="#" selected>艮（こん・こんづくり）</option>
                                        ...
                                        <option value="#" selected>艮（ねづくり）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06019">漢検級順</a></li>
                                   <li><a href="cbushu06019">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：艮部（うしとら・こん・こんづくり・ねづくり）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical138">English</option>
                                             <option value="bushu06019">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06019 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:08 GMT -->
