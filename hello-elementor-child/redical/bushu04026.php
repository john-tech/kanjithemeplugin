...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：斗部（とます・と）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>斗部とは？</h2>
                              <p><strong>斗部（とぶ）は、<span
                                             class="marker">ます、ひしゃく、計る、汲（く）むなどの意味を持つ字</span>が主に属します。</strong>「斗」は「とます」「と」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>斗（と）</option>
                                        ...
                                        <option value="#" selected>斗（とます）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04026">漢検級順</a></li>
                                   <li><a href="cbushu04026">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：斗部（とます・と）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts05">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/19934">㪲</a></li>
                                        <li><a href="kanjiy/19935">㪳</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical68">English</option>
                                             <option value="bushu04026">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04026 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:31 GMT -->
