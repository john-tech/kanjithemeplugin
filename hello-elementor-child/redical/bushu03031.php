...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：己部（おのれ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>己部とは？</h2>
                              <p><strong>己部（きぶ）は、主に字形から文字を整理するために設けられた部首であり、<span class="marker">「己」「巳
                                             」「已」の形を構成にした字</span>が属します。</strong>「己」は「おのれ」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>己 巳 已（おのれ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03031">漢検級順</a></li>
                                   <li><a href="cbushu03031">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：己部（おのれ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts08">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14602">巶</a></li>
                                        <li><a href="kanjiy/19450">㠰</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical49">English</option>
                                             <option value="bushu03031">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03031 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:04 GMT -->
