...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：丨部（たてぼう・ぼう）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>丨部とは？</h2>
                              <p><strong>丨部（こんぶ）は、<span
                                             class="marker">主に字形から文字を整理するために設けられた部首であり、特定の意味は持たない</span>とされます。</strong>
                              </p>
                              <p>また、丨が単独で用いられた例はないとも言われています。「丨」は「たてぼう」「ぼう」と呼びます。</p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>丨（たてぼう）</option>
                                        ...
                                        <option value="#" selected>丨（ぼう）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu01003">漢検級順</a></li>
                                   <li><a href="cbushu01003">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：丨部（たてぼう・ぼう）の漢字一覧</h2>
