...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：⺍部（つ・つかんむり）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>⺍部とは？</h2>
                              <p>⺍部（つぶ）は、字形を簡略化するときに用いられる「⺍」の形を構成にした字のうち、元の部首に分類できなくなった字が属します。営（旧字体＝營）、巣（旧字体＝巢）などが⺍部に分類されます。
                              </p>
                              <p>※営は口部、巣は木部に分類されることもあります。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>⺍（つ・つかんむり）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03029">漢検級順</a></li>
                                   <li><a href="cbushu03029">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：⺍部（つ・つかんむり）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical215">English</option>
                                             <option value="bushu03029">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03029 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:01 GMT -->
