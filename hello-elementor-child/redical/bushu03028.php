...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：廴部（えんにょう・いんにょう）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>廴部とは？</h2>
                              <p><strong>廴部（いんぶ）は、<span
                                             class="marker">進む、行く、のびるなどの意味を表す字</span>が主に属します。</strong>「廴」は「えんにょう」「いんにょう」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>廴（いんにょう）</option>
                                        ...
                                        <option value="#" selected>廴（えんにょう）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03028">漢検級順</a></li>
                                   <li><a href="cbushu03028">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：廴部（えんにょう・いんにょう）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts08">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/26944">㢠</a></li>
                                        <li><a href="kanjiy/27832">𢌞</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical54">English</option>
                                             <option value="bushu03028">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03028 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:00 GMT -->
