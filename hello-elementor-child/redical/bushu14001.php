...
<body>
     <div id="all">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：鼻部（はな・はなへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>鼻部とは？</h2>
                              <p><strong>鼻部（びぶ）は、<span
                                             class="marker">鼻の機能や状態に関する字</span>が属します。</strong>「鼻」は「はな」、偏になった形を「はなへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>鼻（はな・はなへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu14001">漢検級順</a></li>
                                   <li><a href="cbushu14001">読み順</a></li>
                              </ul>
                              <ul class="search_menu2">
                                   ...
                                   <li><a href="#parts36">36画</a></li>
                              </ul>
                         </div><!--search_data-->
                        
                         <h2 class="left_border">部首：鼻部（はな・はなへん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts27">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="18600">齈</a></li>
                                        <li><a href="23696">䶐</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts29">
                                   <h3 class="ttl_while"><a href="kakusu29">２９画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="23697">䶑</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts36">
                                   <h3 class="ttl_while"><a href="kakusu36">３６画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="6521">齉</a></li>
                                   </ul>
                              </div>
                         </div><!--bushu_wrap-->
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical209">English</option>
                                             <option value="bushu14001">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu14001 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:42:11 GMT -->
