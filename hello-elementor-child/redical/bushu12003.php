...
<body>
     <div id="all">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：黹部（ち・ぬいとり・ふつへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>黹部とは？</h2>
                              <p><strong>黹部（ちぶ）は、<span
                                             class="marker">衣服の模様（刺繍）に関する字</span>が属します。</strong>「黹」は「ち」「ぬいとり」、偏になった形を「ふつへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>黹（ち）</option>
                                        ...
                                        <option value="#" selected>黹（ぬいとり）</option>
                                        ...
                                        <option value="#" selected>黹（ふつへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu12003">漢検級順</a></li>
                                   <li><a href="cbushu12003">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：黹部（ち・ぬいとり・ふつへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical204">English</option>
                                             <option value="bushu12003">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu12003 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:42:08 GMT -->
