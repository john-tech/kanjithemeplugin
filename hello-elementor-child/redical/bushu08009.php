...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：齊・斉部（せい）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>齊・斉部とは？</h2>
                              <p><strong>齊・斉部（せいぶ）は、<span
                                             class="marker">「齊」「斉」の形を構成にした字</span>が属します。</strong>「齊」「斉」は「せい」と呼びます。</p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>齊 斉（せい）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu08009">漢検級順</a></li>
                                   <li><a href="cbushu08009">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：齊・斉部（せい）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical210">English</option>
                                             <option value="bushu08009">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu08009 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:41 GMT -->
