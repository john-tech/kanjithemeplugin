...
?>
  ...
  <div class="contents_bnr link_sp">
    ...
    <div id="wrapper" class="cf">
      <div id="content">
        <h1 class="ttl_main">部首：而部（しこうして・しかして）の漢字</h1>

        <div class="bushu_about">
          <div class="bushu_about_box">
            <h2>而部とは？</h2>
            <p>而はひげの形にかたどり、<strong>而部（じぶ）は<span
                  class="marker">ひげに関する字、「而」の形を構成にした字</span>が属します。</strong>「而」は「しこうして」「しかして」と呼びます。</p>
          </div>
        </div>
        <div class="parts_data">
          <div class="search_narrowdown">
            ...
            <div class="narrowdown_select">
              <select name="select" onChange="location.href=value;" class="select1">
                ...
                <option value="#" selected>而（しかして）</option>
                ...
                <option value="#" selected>而（しこうして）</option>
          ...
          <div class="search_data bushu_menu">
            <ul class="search_menu">
              <li>画数順</li>
              <li><a href="bbushu06024">漢検級順</a></li>
              <li><a href="cbushu06024">読み順</a></li>
            </ul>
          ...
          <aside>
            <div class="ads_wraptop2 link_sp">
              ...
              <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-3664445671894613"
                data-ad-slot="8563864342" data-ad-format="auto" data-full-width-responsive="true"></ins>
              <script>
                (adsbygoogle = window.adsbygoogle || []).push({});
              </script>
            </div>
          </aside>
          <h2 class="left_border">部首：而部（しこうして・しかして）の漢字一覧</h2>
        ...
        <div id="sidebar" data-nosnippet>
          ...
          <div class="ads_wrap side_pc">
            ...
            <script async src="../../pagead2.googlesyndication.com/pagead/js/fb9f7.txt?client=ca-pub-3664445671894613"
              crossorigin="anonymous"></script>
            <!-- 漢字辞典レスポンシブ２ -->
            <ins class="adsbygoogle ads_responsive_2" style="display:inline-block"
              data-ad-client="ca-pub-3664445671894613" data-ad-slot="6642164275"></ins>
            <script>
              (adsbygoogle = window.adsbygoogle || []).push({});
            </script>
          </div>
            ...
            <div class="side_box">
              ...
              <div class="ChangeElem_Panel2">
                <ul class="side_rank sr_01">
                  ...
                  <li><a href="12934" title="漢字「殺」のページ"><span
            ...
            <div class="language_footer">
              <div class="lan_inner">
                <select name="select" onChange="location.href=value;" tabindex="0">
                  ...
                  <option value="radical126">English</option>
                  <option value="bushu06024">Japanese</option>
                </select>
              </div>
            </div>
          </div>
...
<!-- Mirrored from bushu06024 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:12 GMT -->
