...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：曰部（いわく・ひらび）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>曰部とは？</h2>
                              <p>曰は口から言葉を発するさまを表し、<strong>曰部（えつぶ）には<span
                                             class="marker">「曰」の形を構成にした字</span>が属します。</strong>「曰」は「いわく」「ひらび」と呼びます。</p>
                              <p>「<a href="bushu04008">日（ひ・ひへん・にち・にちへん）</a>」は別の部首ですが、形が似ていることから同一の場所で扱われることもあります。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>曰（いわく）</option>
                                        ...
                                        <option value="#" selected>曰（ひらび）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04014">漢検級順</a></li>
                                   <li><a href="cbushu04014">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：曰部（いわく・ひらび）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical73">English</option>
                                             <option value="bushu04014">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04014 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:24 GMT -->
