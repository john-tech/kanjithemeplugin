...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：疒部（やまいだれ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>疒部とは？</h2>
                              <p>疒は人が病気で寝台によりかかる（寝ている）姿にかたどり、<strong>疒部（だくぶ）には<span
                                             class="marker">病気や病状に関する字</span>が主に属します。</strong>「疒」は「やまいだれ」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>疒（やまいだれ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05016">漢検級順</a></li>
                                   <li><a href="cbushu05016">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：疒部（やまいだれ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical104">English</option>
                                             <option value="bushu05016">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05016 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:50 GMT -->
