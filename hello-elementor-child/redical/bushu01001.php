...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：一部（いち）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>一部とは？</h2>
                              <p>漢字の一は、「ひとつ」「はじめ」などの意味を持ちますが、<strong>部首としての一（一部：いちぶ）は、<span
                                             class="marker">主に字形から文字を整理するために設けられたものであり、特定の意味は持たない</span>とされます。</strong>「一」は「いち」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>一（いち）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu01001">漢検級順</a></li>
                                   <li><a href="cbushu01001">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：一部（いち）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts01">
                                   ...
                                   <ul class="search_parts">
                                        <li><a class="color1" href="kanji/001">一</a></li>
                              ...
                              <div class="parts_box" id="parts04">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/24391">㐄</a></li>
                                        <li><a href="kanjiy/26238">龶</a></li>
                                        <li><a href="kanjiy/27695">𠀋</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts05">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13005">业</a></li>
                                        <li><a href="kanjiy/24528">丛</a></li>
                                        <li><a href="kanjiy/24530">丝</a></li>
                                        <li><a href="kanjiy/27718">𠀑</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13668">坙</a></li>
                                        <li><a href="kanjiy/24531">严</a></li>
                                   </ul>
                              </div>
