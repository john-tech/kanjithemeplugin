...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：米部（こめ・こめへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>米部とは？</h2>
                              <p><strong>米部（べいぶ）は、<span
                                             class="marker">米をはじめとした穀物、また穀物を加工して作られたもの（特に食品）などに関する字</span>が主に属します。</strong>「米」は「こめ」、偏になった形を「こめへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>米（こめ・こめへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06014">漢検級順</a></li>
                                   <li><a href="cbushu06014">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：米部（こめ・こめへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical119">English</option>
                                             <option value="bushu06014">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06014 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:05 GMT -->
