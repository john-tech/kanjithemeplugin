...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：戶部（と・とだれ・とかんむり・とびらのと）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>戶部とは？</h2>
                              <p>戶は、両開きのとびらの片方、また片開のとびらの形にかたどり、<strong>戶部（こぶ）には<span
                                             class="marker">とびら、住居などに関する字</span>が主に属します。</strong>「戶」は「と」「とびらのと」、垂れになった形を「とだれ」、冠（かんむり）になった形を「とかんむり」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>戶 戸（と）</option>
                                        <option value="bushu04026">斗（と）</option>
                                        <option value="bushu10008">鬥（とうがまえ）</option>
                                        <option value="#" selected>戶 戸（とかんむり・とだれ・とびらのと）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04013">漢検級順</a></li>
                                   <li><a href="cbushu04013">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：戶部（と・とだれ・とかんむり・とびらのと）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14900">戼</a></li>
                                        <li><a href="kanjiy/19756">㦾</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts08">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/19757">㦿</a></li>
                                        <li><a href="kanjiy/19758">㧀</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/19759">㧁</a></li>
                                        <li><a href="kanjiy/19760">㧂</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical63">English</option>
                                             <option value="bushu04013">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04013 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:23 GMT -->
