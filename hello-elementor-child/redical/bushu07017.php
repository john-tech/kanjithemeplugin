...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：臣部（しん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>臣部とは？</h2>
                              <p>臣は目を見開いた形、または服従する人の形にかたどり、<strong>臣部（しんぶ）は<span
                                             class="marker">「臣」の形を構成にした字</span>が属します。</strong>「臣」は「しん」と呼びます。「臣」は、６画として扱われる場合と７画として扱われる場合があります。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>臣（しん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu07017">漢検級順</a></li>
                                   <li><a href="cbushu07017">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：臣部（しん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical131">English</option>
                                             <option value="bushu07017">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu07017 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:15 GMT -->
