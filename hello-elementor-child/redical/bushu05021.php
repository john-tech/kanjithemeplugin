...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：无部（む・むにょう・ぶ・なし・すでのつくり）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>无部とは？</h2>
                              <p>无は無いこと、旡は食べ物がのどにつまることを表します。<strong>无部（むぶ）には、<span
                                             class="marker">「无」「旡」の形を構成にした字</span>が属します。</strong></p>
                              <p>「无」は「む」「ぶ」「なし」「むにょう」「すでのつくり」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>无 旡（すでのつくり）</option>
                                        ...
                                        <option value="#" selected>无 旡（なし）</option>
                                        ...
                                        <option value="#" selected>无 旡（ぶ）</option>
                                        ...
                                        <option value="#" selected>无 旡（む）</option>
                                        ...
                                        <option value="#" selected>无 旡（むにょう）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05021">漢検級順</a></li>
                                   <li><a href="cbushu05021">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：无部（む・むにょう・ぶ・なし・すでのつくり）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical71">English</option>
                                             <option value="bushu05021">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05021 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:38 GMT -->
