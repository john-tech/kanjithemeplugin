...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：斤部（おのづくり・おの・きん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>斤部とは？</h2>
                              <p>斤はおのの形にかたどり、<strong>斤部（きんぶ）には、<span
                                             class="marker">おの、おの（刃物）で切る行為などに関する字</span>が主に属します。</strong>「斤」は「おの」「きん」、旁（つくり）になった形を「おのづくり」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>斤（おの・おのづくり）</option>
                                        ...
                                        <option value="#" selected>斤（きん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04015">漢検級順</a></li>
                                   <li><a href="cbushu04015">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：斤部（おのづくり・おの・きん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/15076">斪</a></li>
                                        <li><a href="kanjiy/19942">㪼</a></li>
                                        <li><a href="kanjiy/19943">㪽</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical69">English</option>
                                             <option value="bushu04015">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04015 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:25 GMT -->
