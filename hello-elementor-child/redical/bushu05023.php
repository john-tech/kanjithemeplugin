...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：禸部（ぐうのあし・じゅう・じゅうのあし）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>禸部とは？</h2>
                              <p>禸は動物の足の形（虫の形）にかたどり、<strong>禸部（じゅうぶ）は<span
                                             class="marker">動物に関する字</span>が主に属します。</strong>「禸」は「ぐうのあし」「じゅう」「じゅうのあし」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>禸（ぐうのあし）</option>
                                        ...
                                        <option value="#" selected>禸（じゅう・じゅうのあし）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05023">漢検級順</a></li>
                                   <li><a href="cbushu05023">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：禸部（ぐうのあし・じゅう・じゅうのあし）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical114">English</option>
                                             <option value="bushu05023">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05023 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:55 GMT -->
