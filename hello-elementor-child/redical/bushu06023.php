...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：至部（いたる・いたるへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>至部とは？</h2>
                              <p>至は矢が地面に突き刺さる（届く）形にかたどり、<strong>至部（しぶ）は<span
                                             class="marker">いたる、およぶなどの意味を表す字</span>が主に属します。</strong>「至」は「いたる」、偏になった形を「いたるへん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>至（いたる・いたるへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06023">漢検級順</a></li>
                                   <li><a href="cbushu06023">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：至部（いたる・いたるへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical133">English</option>
                                             <option value="bushu06023">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06023 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:12 GMT -->
