...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：凵部（かんにょう・うけばこ・かんがまえ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>凵部とは？</h2>
                              <p>凵は、「くぼんださま」「口が開いているさま」などを表しますが、<strong>部首としての凵（凵部：かんぶ）は、<span
                                             class="marker">主に字形から文字を整理するために設けられたものであり、特定の意味は持たない</span>とされます。</strong>「凵」は「かんにょう」「うけばこ」「かんがまえ」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>凵（うけばこ）</option>
                                        ...
                                        <option value="#" selected>凵（かんがまえ・かんにょう）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02005">漢検級順</a></li>
                                   <li><a href="cbushu02005">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：凵部（かんにょう・うけばこ・かんがまえ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts05">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12731">凷</a></li>
                                        <li><a href="kanjiy/24716">击</a></li>
                                        <li><a href="kanjiy/27730">𠙺</a></li>
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14387">岀</a></li>
                                        <li><a href="kanjiy/18779">㓙</a></li>
                                        <li><a href="kanjiy/24718">凼</a></li>
                                   </ul>
                              </div>
