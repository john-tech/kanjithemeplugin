...
<body>
     <div id="all">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：黑・黒部（くろ・くろへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>黑・黒部とは？</h2>
                              <p><strong>黑・黒部（こくぶ）は、<span
                                             class="marker">黒い色、黒いものに関する字</span>が主に属します。</strong>「黑」「黒」は「くろ」、偏になった形を「くろへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>黑 黒（くろ・くろへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu11003">漢検級順</a></li>
                                   <li><a href="cbushu11003">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：黑・黒部（くろ・くろへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical203">English</option>
                                             <option value="bushu11003">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu11003 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:42:02 GMT -->
