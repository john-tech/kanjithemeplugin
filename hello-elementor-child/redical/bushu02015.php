...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：又部（また）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>又部とは？</h2>
                              <p>又は右手の形にかたどり、<strong>又部（ゆうぶ）は<span
                                             class="marker">手や手の動作に関する字</span>が主に属します。</strong>「又」は「また」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>又（また）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02015">漢検級順</a></li>
                                   <li><a href="cbushu02015">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：又部（また）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts04">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/18871">㕚</a></li>
                                        <li><a href="kanjiy/24194">㕛</a></li>
                                        <li><a href="kanjiy/27762">𠬝</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts05">
                                   <h3 class="ttl_while"><a href="kakusu05">５画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/13213">叏</a></li>
                                        <li><a href="kanjiy/23896">叐</a></li>
                                        <li><a href="kanjiy/24773">发</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/13214">叒</a></li>
                                        <li><a href="kanjiy/24195">㕜</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts08">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13215">叕</a></li>
                                        <li><a href="kanjiy/18872">㕞</a></li>
                                        <li><a href="kanjiy/24775">变</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13216">叚</a></li>
                                        <li><a href="kanjiy/18873">㕟</a></li>
                                        <li><a href="kanjiy/23897">叝</a></li>
                                        <li><a href="kanjiy/24776">叜</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts14">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/18633">﨎</a></li>
                                        <li><a href="kanjiy/18875">㕡</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical29">English</option>
                                             <option value="bushu02015">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu02015 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:31 GMT -->
