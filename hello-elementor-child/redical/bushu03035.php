...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：彑・彐部（けいがしら・いのこがしら）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>彑・彐部とは？</h2>
                              <p>彑・彐は豚の頭にかたどり、<strong>彑・彐部（けいぶ）には<span
                                             class="marker">豚に関する字</span>が主に属します。</strong>「彑」「彐」は「けいがしら」「いのこがしら」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>彑 彐（いのこがしら）</option>
                                        ...
                                        <option value="#" selected>彑 彐（けいがしら）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03035">漢検級順</a></li>
                                   <li><a href="cbushu03035">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：彑・彐部（けいがしら・いのこがしら）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts03">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/23986">彐</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts05">
                                   <h3 class="ttl_while"><a href="kakusu05">５画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/13140">刍</a></li>
                                        <li><a href="kanjiy/14754">归</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts08">
                                   <h3 class="ttl_while"><a href="kakusu08">８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14755">彔</a></li>
                                        <li><a href="kanjiy/23987">录</a></li>
                                        <li><a href="kanjiy/24215">㣇</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts16">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14757">彛</a></li>
                                        <li><a href="kanjiy/19578">㣈</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical58">English</option>
                                             <option value="bushu03035">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03035 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:10 GMT -->
