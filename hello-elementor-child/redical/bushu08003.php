...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：靑部（あお・あおへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>靑部とは？</h2>
                              <p><strong>靑部（せいぶ）は、<span
                                             class="marker">「靑」「青」の形を構成にした字</span>が属します。</strong>「靑」「青」は「あお」、偏になった形を「あおへん」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        <option value="#" selected>靑 青（あお・あおへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu08003">漢検級順</a></li>
                                   <li><a href="cbushu08003">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：靑部（あお・あおへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical174">English</option>
                                             <option value="bushu08003">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu08003 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:34 GMT -->
