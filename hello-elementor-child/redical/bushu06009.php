...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：自部（みずから）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>自部とは？</h2>
                              <p>自は鼻（はな）の形にかたどり、<strong>自部（じぶ）には<span
                                             class="marker">鼻や嗅覚などに関する字</span>が主に属します。</strong>「自」は「みずから」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>自（みずから）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06009">漢検級順</a></li>
                                   <li><a href="cbushu06009">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：自部（みずから）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical132">English</option>
                                             <option value="bushu06009">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06009 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:02 GMT -->
