...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：疋部（ひき・ひきへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>疋部とは？</h2>
                              <p><strong>疋部（しょぶ）は、主に字形から文字を整理するために設けられた部首であり、<span
                                             class="marker">「疋」の形を構成にした字</span>が属します。</strong>「疋」は「ひき」、偏になった形を「ひきへん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>疋（ひき・ひきへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05018">漢検級順</a></li>
                                   <li><a href="cbushu05018">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：疋部（ひき・ひきへん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts05">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="24696">⺪</a></li>
                                        <li><a href="27770">𤴔</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical103">English</option>
                                             <option value="bushu05018">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05018 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:52 GMT -->
