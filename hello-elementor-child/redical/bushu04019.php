...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：毋部（なかれ・ははのかん・はは）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>毋部とは？</h2>
                              <p><strong>毋部（ぶぶ）は、主に字形から文字を整理するために設けられた部首であり、<span
                                             class="marker">「毋（母）」の形を構成にした字</span>が属します。</strong></p>
                              <p>「毋」と「母」は別の字ですが、形が似ているため同一部首として扱われます。「毋」は「なかれ」「ははのかん」、「母」は「はは」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>毋 母（なかれ）</option>
                                        ...
                                        <option value="#" selected>毋 母（はは・ははのかん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04019">漢検級順</a></li>
                                   <li><a href="cbushu04019">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：毋部（なかれ・ははのかん・はは）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical80">English</option>
                                             <option value="bushu04019">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04019 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:27 GMT -->
