...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：矢部（や・やへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>矢部とは？</h2>
                              <p><strong>矢部（しぶ）は、<span
                                             class="marker">矢に関する字</span>などが主に属します。</strong>「矢」は「や」、偏になった形を「やへん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>矢（や）</option>
                                        <option value="bushu17001">龠（やく・やくのふえ）</option>
                                        <option value="#" selected>矢（やへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05010">漢検級順</a></li>
                                   <li><a href="cbushu05010">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：矢部（や・やへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical111">English</option>
                                             <option value="bushu05010">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05010 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:47 GMT -->
