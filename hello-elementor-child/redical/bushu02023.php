...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：匚部（はこがまえ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>匚部とは？</h2>
                              <p><strong>匚部（ほうぶ）は、<span
                                             class="marker">四角い箱、物を入れる箱に関する字</span>が主に属します。</strong>「匚」は「はこがまえ」と呼びます。
                              </p>
                              <p>「匚（はこがまえ）」と「<a href="bushu02016">匸（かくしがまえ）</a>」は別の部首ですが、常用漢字においては区別しないこともあります。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>匚（はこがまえ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02023">漢検級順</a></li>
                                   <li><a href="cbushu02023">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：匚部（はこがまえ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/24190">㔰</a></li>
                                        <li><a href="kanjiy/27720">𠥱</a></li>
                                        <li><a href="kanjiy/27739">𠤵</a></li>
                                        <li><a class="color1" href="kanji/245">医</a></li>
                                        <li><a href="3204">匣</a></li>
                                        <li><a href="kanjiy/12957">匤</a></li>
                                        <li><a href="kanjiy/12960">㔯</a></li>
                                        <li><a href="kanjiy/12963">匥</a></li>
                                        <li><a href="kanjiy/12971">㔷</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts08">
                                   <h3 class="ttl_while"><a href="kakusu08">８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/23811">匦</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12952">匩</a></li>
                                        <li><a href="kanjiy/12985">匨</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts10">
                                   <h3 class="ttl_while"><a href="kakusu10">１０画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12986">匫</a></li>
                                        <li><a href="kanjiy/26192">龨</a></li>
                              ...
                              <div class="parts_box" id="parts11">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12988">匭</a></li>
                                        <li><a href="kanjiy/12990">匬</a></li>
                                        <li><a href="kanjiy/24191">㔱</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts12">
                                   <h3 class="ttl_while"><a href="kakusu12">１２画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/18843">㔸</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts13">
                                   <h3 class="ttl_while"><a href="kakusu13">１３画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/18840">㔳</a></li>
                                        <li><a href="kanjiy/24192">㔴</a></li>
                                        <li><a href="kanjiy/26495">㔲</a></li>
                              ...
                              <div class="parts_box" id="parts14">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12992">匰</a></li>
                                        <li><a href="kanjiy/18841">㔵</a></li>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical22">English</option>
                                             <option value="bushu02023">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu02023 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:36 GMT -->
