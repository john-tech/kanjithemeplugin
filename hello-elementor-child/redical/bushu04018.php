...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：父部（ちち）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>父部とは？</h2>
                              <p><strong>父部（ふぶ）は、<span class="marker">父親や長老などに関する字</span>が主に属します。</strong>「父」は「ちち」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>父（ちち）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04018">漢検級順</a></li>
                                   <li><a href="cbushu04018">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：父部（ちち）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts10">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/16280">爹</a></li>
                                        <li><a href="kanjiy/20557">㸗</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts11">
                                   <h3 class="ttl_while"><a href="kakusu11">１１画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/20558">㸘</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical88">English</option>
                                             <option value="bushu04018">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04018 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:26 GMT -->
