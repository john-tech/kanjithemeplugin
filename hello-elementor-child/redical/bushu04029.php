...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：比部（くらべる・ならびひ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>比部とは？</h2>
                              <p>比の字をもとに作られた字はきわめて少ないとされ、<strong>比部（ひぶ）は、主に文字を整理するために設けられた部首であり、<span
                                             class="marker">「比」の形を構成にした字</span>が属します。</strong>「比」は「くらべる」「ならびひ」と呼びます。</p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>比（くらべる）</option>
                                        ...
                                        <option value="#" selected>比（ならびひ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04029">漢検級順</a></li>
                                   <li><a href="cbushu04029">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：比部（くらべる・ならびひ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12964">㲋</a></li>
                                        <li><a href="kanjiy/12966">毖</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts10">
                                   <h3 class="ttl_while"><a href="kakusu10">１０画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/25449">毙</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical81">English</option>
                                             <option value="bushu04029">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04029 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:33 GMT -->
