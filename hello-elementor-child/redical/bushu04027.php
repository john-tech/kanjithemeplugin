...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：支部（し・しにょう・えだにょう・じゅうまた）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>支部とは？</h2>
                              <p><strong>支部（しぶ）は、<span class="marker">分かれること、支えることなどに関する字</span>が主に属します。</strong></p>
                              <p>「支」は「し」「しにょう」「えだにょう」、また「十」と「又」を組み合わせた形から「じゅうまた」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>支（えだにょう）</option>
                                        ...
                                        <option value="#" selected>支（し）</option>
                                        ...
                                        <option value="#" selected>支（しにょう）</option>
                                        ...
                                        <option value="#" selected>支（じゅうまた）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04027">漢検級順</a></li>
                                   <li><a href="cbushu04027">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：支部（し・しにょう・えだにょう・じゅうまた）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical65">English</option>
                                             <option value="bushu04027">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04027 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:32 GMT -->
