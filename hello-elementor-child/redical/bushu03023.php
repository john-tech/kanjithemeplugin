...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：寸部（すん・すんづくり）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>寸部とは？</h2>
                              <p><strong>寸部（すんぶ）は、<span
                                             class="marker">手の動作に関する字</span>が主に属します。</strong>「寸」は「すん」、旁（つくり）になった形を「すんづくり」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>寸（すん・すんづくり）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03023">漢検級順</a></li>
                                   <li><a href="cbushu03023">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：寸部（すん・すんづくり）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts05">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14330">对</a></li>
                                        <li><a href="kanjiy/26894">㝳</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/25092">寻</a></li>
                                        <li><a href="kanjiy/25093">导</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12745">㝴</a></li>
                                        <li><a href="kanjiy/14331">寽</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts08">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14332">尀</a></li>
                                        <li><a href="kanjiy/19298">㝵</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts10">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14333">尃</a></li>
                                        <li><a href="kanjiy/19299">㝶</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts12">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14334">尌</a></li>
                                        <li><a href="kanjiy/20505">㷉</a></li>
                                        <li><a href="kanjiy/26895">㝷</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical41">English</option>
                                             <option value="bushu03023">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03023 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:54 GMT -->
