...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：爿部（しょうへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>爿部とは？</h2>
                              <p><strong>爿部（しょうぶ）は、主に字形から文字を整理するために設けられた部首であり、<span
                                             class="marker">「爿」の形を構成にした字</span>が属します。</strong>「爿」は「しょうへん」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>爿（しょうへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04033">漢検級順</a></li>
                                   <li><a href="cbushu04033">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：爿部（しょうへん）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/16281">牁</a></li>
                                        <li><a href="kanjiy/20561">㸛</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical90">English</option>
                                             <option value="bushu04033">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04033 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:36 GMT -->
