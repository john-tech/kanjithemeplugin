...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：入部（いる・にゅう・いりがしら・いりやね）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>入部とは？</h2>
                              <p><strong>入部（にゅうぶ）は、入の字をもとに作られた字はなく、<span
                                             class="marker">主に字形から文字を整理するために設けられた部首であり、特定の意味は持たない</span>とされます。</strong>「内」「全」「両」の旧字体などがこの部首に属します。「入」は「にゅう」「いる」、冠（かんむり）になった形を「いりがしら」「いりやね」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>入（いりがしら・いりやね・いる）</option>
                                        ...
                                        <option value="#" selected>入（にゅう）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02007">漢検級順</a></li>
                                   <li><a href="cbushu02007">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：入部（いる・にゅう・いりがしら・いりやね）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts04">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12696">內</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts05">
                                   <h3 class="ttl_while"><a href="kakusu05">５画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12391">㒰</a></li>
                                        <li><a href="kanjiy/14378">屳</a></li>
                                        <li><a href="kanjiy/26413">㒱</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/18753">㒲</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts07">
                                   <h3 class="ttl_while"><a href="kakusu07">７画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/18754">㒳</a></li>
                                        <li><a href="kanjiy/18755">㒴</a></li>
                                   </ul>
                              </div>
