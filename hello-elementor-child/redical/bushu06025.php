...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：虍部（とらかんむり・とらがしら・とら）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>虍部とは？</h2>
                              <p><strong>虍は虎（とら）の頭の形にかたどり、<span
                                             class="marker">虍部（こぶ）は虎に関する字</span>が主に属します。</strong>「虍」は「とら」、虍は冠（かんむり）の形になることが多く、冠の形を「とらかんむり」「とらがしら」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>虍（とら・とらかんむり・とらがしら）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu06025">漢検級順</a></li>
                                   <li><a href="cbushu06025">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：虍部（とらかんむり・とらがしら・とら）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical141">English</option>
                                             <option value="bushu06025">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu06025 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:13 GMT -->
