...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：癶部（はつがしら）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>癶部とは？</h2>
                              <p>癶は両足を開いた形にかたどり、<strong>癶部（はつぶ）は<span
                                             class="marker">足の動作に関する字、「癶」の形を構成にした字</span>が属します。</strong>「癶」は「はつがしら」と呼びます。
                              </p>
                              <p></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>癶（はつがしら）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05014">漢検級順</a></li>
                                   <li><a href="cbushu05014">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：癶部（はつがしら）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical105">English</option>
                                             <option value="bushu05014">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05014 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:49 GMT -->
