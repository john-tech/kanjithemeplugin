...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：瓦部（かわら）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>瓦部とは？</h2>
                              <p><strong>瓦部（がぶ）は、<span
                                             class="marker">かわら、焼き物、土器などに関する字</span>が主に属します。</strong>「瓦」は「かわら」と呼びます。</p>
                              <p>瓦は日本ではグラム（重さの単位）の意味を持つことから、重さの単位に関する国字の偏に用いられます。例：「<a
                                        href="4865">瓩</a>」「<a
                                        href="4864">瓧</a>」「<a
                                        href="4869">瓱</a>」「<a
                                        href="4871">瓸</a>」「<a
                    ...
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>瓦（かわら）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu05022">漢検級順</a></li>
                                   <li><a href="cbushu05022">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：瓦部（かわら）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical98">English</option>
                                             <option value="bushu05022">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu05022 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:54 GMT -->
