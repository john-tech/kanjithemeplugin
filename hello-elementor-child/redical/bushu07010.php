...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：里部（さと・さとへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>里部とは？</h2>
                              <p><strong>里部（りぶ）は、<span
                                             class="marker">村里に関する字、「里」の形を構成にした字</span>などが属します。</strong>「里」は「さと」、偏になった形を「さとへん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>里（さと・さとへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu07010">漢検級順</a></li>
                                   <li><a href="cbushu07010">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：里部（さと・さとへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical166">English</option>
                                             <option value="bushu07010">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu07010 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:25 GMT -->
