...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：勹部（つつみがまえ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>勹部とは？</h2>
                              <p><strong>勹部（ほうぶ）は、<span
                                             class="marker">包み込むこと、抱え込むことなどに関する字</span>が多く属します。</strong>「勹」は「つつみがまえ」と呼びます。また、「くがまえ」「ほうがまえ」などと呼ぶこともあります。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>勹（つつみがまえ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02020">漢検級順</a></li>
                                   <li><a href="cbushu02020">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：勹部（つつみがまえ）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts04">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12916">勻</a></li>
                                        <li><a href="kanjiy/12917">匀</a></li>
                                        <li><a href="kanjiy/12918">勼</a></li>
                                        <li><a href="kanjiy/13167">勽</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts05">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12921">匃</a></li>
                                        <li><a href="kanjiy/12922">匄</a></li>
                                        <li><a href="kanjiy/12923">匇</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12927">匉</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts08">
                                   <h3 class="ttl_while"><a href="kakusu08">８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12936">匊</a></li>
                                        <li><a href="kanjiy/12939">匌</a></li>
                                        <li><a href="kanjiy/12943">匋</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical20">English</option>
                                             <option value="bushu02020">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu02020 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:34 GMT -->
