...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：角部（つの・つのへん・かく）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>角部とは？</h2>
                              <p>角は動物の角（つの）の形にかたどり、<strong>角部（かくぶ）は<span
                                             class="marker">角の状態や角でつくったものなどに関する字</span>が主に属します。</strong>「角」は「つの」「かく」、偏になった形を「つのへん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>角（かく）</option>
                                        ...
                                        <option value="#" selected>角（つの・つのへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu07006">漢検級順</a></li>
                                   <li><a href="cbushu07006">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：角部（つの・つのへん・かく）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical148">English</option>
                                             <option value="bushu07006">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu07006 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:22 GMT -->
