...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：工部（え・たくみ・たくみへん・こう）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>工部とは？</h2>
                              <p><strong>工部（こうぶ）は、<span
                                             class="marker">工具や工作に関する字</span>が主に属します。</strong>「工」は「え」「たくみ」「こう」、偏になった形を「たくみへん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>工（え）</option>
                                        ...
                                        <option value="#" selected>工（こう）</option>
                                        ...
                                        <option value="#" selected>工（たくみ・たくみへん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03004">漢検級順</a></li>
                                   <li><a href="cbushu03004">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：工部（え・たくみ・たくみへん・こう）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14601">巪</a></li>
                                        <li><a href="kanjiy/23968">巩</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts09">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/25205">巬</a></li>
                                        <li><a href="kanjiy/25206">巭</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical48">English</option>
                                             <option value="bushu03004">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03004 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:40 GMT -->
