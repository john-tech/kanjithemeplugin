...
<body>
     <div id="all">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：麻部（あさ・あさかんむり）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>麻部とは？</h2>
                              <p><strong>麻部（まぶ）は、<span
                                             class="marker">麻（あさ）に関する字、「麻」の形を構成にした字</span>などが属します。</strong>「麻」は「あさ」、麻は冠（かんむり）の形になることが多く、冠の形を「あさかんむり」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>麻（あさ・あさかんむり）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu11007">漢検級順</a></li>
                                   <li><a href="cbushu11007">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：麻部（あさ・あさかんむり）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical200">English</option>
                                             <option value="bushu11007">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu11007 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:42:04 GMT -->
