...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：彡部（さんづくり）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>彡部とは？</h2>
                              <p><strong>彡部（さんぶ）は、<span
                                             class="marker">飾り、模様、彩りなどに関する字</span>が主に属します。</strong>「彡」は、彡の音の「サン」と旁（つくり）の意味から「さんづくり」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>彡（さんづくり）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03020">漢検級順</a></li>
                                   <li><a href="cbushu03020">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：彡部（さんづくり）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14760">彣</a></li>
                                        <li><a href="kanjiy/14761">彤</a></li>
                                        <li><a href="kanjiy/26954">㣊</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts08">
                                   <h3 class="ttl_while"><a href="kakusu08">８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/19580">㣋</a></li>
                                        <li><a href="kanjiy/19581">㣌</a></li>
                                        <li><a href="kanjiy/19582">㣍</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts10">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14763">彧</a></li>
                                        <li><a href="kanjiy/25226">彨</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts12">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/19584">㣏</a></li>
                                        <li><a href="kanjiy/19585">㣐</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts13">
                                   <h3 class="ttl_while"><a href="kakusu13">１３画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14764">彮</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts14">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14765">彯</a></li>
                                        <li><a href="kanjiy/19586">㣑</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical59">English</option>
                                             <option value="bushu03020">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03020 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:51 GMT -->
