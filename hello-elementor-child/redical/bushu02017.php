...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：厶部（む）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>厶部とは？</h2>
                              <p><strong>厶部（しぶ）は、主に字形から文字を整理するために設けられた部首であり、<span
                                             class="marker">「厶」の形を構成にした字</span>が属します。</strong>「厶」は「む」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>厶（む）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02017">漢検級順</a></li>
                                   <li><a href="cbushu02017">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：厶部（む）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts04">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13205">厹</a></li>
                                        <li><a href="kanjiy/18867">㕕</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts05">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13206">厺</a></li>
                                        <li><a href="kanjiy/24760">厼</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/13207">厽</a></li>
                                        <li><a href="kanjiy/13208">厾</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts07">
                                   <h3 class="ttl_while"><a href="kakusu07">７画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/24761">县</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts08">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13209">叀</a></li>
                                        <li><a href="kanjiy/13210">叁</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts10">
                                   <h3 class="ttl_while"><a href="kakusu10">１０画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/18868">㕖</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical28">English</option>
                                             <option value="bushu02017">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu02017 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:32 GMT -->
