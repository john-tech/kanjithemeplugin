...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：身部（み・みへん）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>身部とは？</h2>
                              <p><strong>身部（しんぶ）は、<span
                                             class="marker">身体の状態に関する字</span>が主に属します。</strong>「身」は「み」、偏になった形を「みへん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu07012">漢検級順</a></li>
                                   <li><a href="cbushu07012">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：身部（み・みへん）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical158">English</option>
                                             <option value="bushu07012">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu07012 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:26 GMT -->
