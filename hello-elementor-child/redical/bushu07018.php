...
<div id="all">
    ...
    <div id="wrapper" class="cf">
        <div id="content">
            <h1 class="ttl_main">部首：釆部（のごめ・のごめへん）の漢字</h1>

            <div class="bushu_about">
                <div class="bushu_about_box">
                    <h2>釆部とは？</h2>
                    <p><strong>釆部（はんぶ）は、<span
                                class="marker">分けるとの意味を持つ字</span>が主に属します。</strong>「釆」は「ノ」と「米」を組み合わせた形から「のごめ」、偏になった形を「のごめへん」と呼びます。
                    </p>
                    <p></p>
                </div>
            </div>
            <div class="parts_data">
                <div class="search_narrowdown">
                    ...
                    <div class="narrowdown_select">
                        <select name="select" onChange="location.href=value;" class="select1">
                            ...
                            <option value="#" selected>釆（のごめ・のごめへん）</option>
                ...
                <div class="search_data bushu_menu">
                    <ul class="search_menu">
                        <li>画数順</li>
                        <li><a href="bbushu07018">漢検級順</a></li>
                        <li><a href="cbushu07018">読み順</a></li>
                    </ul>
                ...
                <h2 class="left_border">部首：釆部（のごめ・のごめへん）の漢字一覧</h2>
                    ...
                    <div class="language_footer">
                        <div class="lan_inner">
                            <select name="select" onChange="location.href=value;" tabindex="0">
                                ...
                                <option value="bushu07018">Japanese</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from bushu07018 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:29 GMT -->
