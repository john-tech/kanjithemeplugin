...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：韋部（なめしがわ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>韋部とは？</h2>
                              <p><strong>韋部（いぶ）は、<span
                                             class="marker">革製品に関する字</span>が主に属します。</strong>「韋」は「なめしがわ」と呼んで、「<a
                                        href="bushu05015">皮（けがわ・ひのかわ）</a>」「<a
                                        href="bushu10007">革（かくのかわ・つくりがわ）</a>」と区別します。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>韋（なめしがわ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu10007">漢検級順</a></li>
                                   <li><a href="cbushu10007">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：韋部（なめしがわ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical178">English</option>
                                             <option value="bushu10007">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
