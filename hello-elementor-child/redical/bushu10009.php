...
<body>
     <div id="all">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：鬲部（かなえ・れき）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>鬲部とは？</h2>
                              <p>鬲はかなえ（三本足のついた器）の形にかたどり、<strong>鬲部（れきぶ）は、<span
                                             class="marker">かなえ、釜、鍋などに関する字</span>が主に属します。</strong>「鬲」は「かなえ」「れき」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>鬲（かなえ）</option>
                                        ...
                                        <option value="#" selected>鬲（れき）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu10009">漢検級順</a></li>
                                   <li><a href="cbushu10009">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：鬲部（かなえ・れき）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical193">English</option>
                                             <option value="bushu10009">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu10009 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:42:00 GMT -->
