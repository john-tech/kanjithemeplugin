...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：廾部（にじゅうあし・こまぬき）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>廾部とは？</h2>
                              <p><strong>廾部（きょうぶ）は、<span
                                             class="marker">両手で持つ、両手で捧げ持つなど両手の動作に関する字</span>が主に属します。</strong></p>
                              <p>「廾」は、二十という意味の「卄（廿）」に似ていることから「にじゅうあし」、またこまねく形（両手を胸の前で組み合わせる形）に似ていることから「こまぬき」と呼びます。</p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>廾（こまぬき）</option>
                                        ...
                                        <option value="#" selected>廾（にじゅうあし）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu03030">漢検級順</a></li>
                                   <li><a href="cbushu03030">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：廾部（にじゅうあし・こまぬき）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/14721">弅</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts08">
                                   <h3 class="ttl_while"><a href="kakusu08">８画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14722">弆</a></li>
                                        <li><a href="kanjiy/18673">㐩</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts09">
                                   <h3 class="ttl_while"><a href="kakusu09">９画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/14723">弇</a></li>
                                        <li><a href="kanjiy/14724">弈</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical55">English</option>
                                             <option value="bushu03030">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu03030 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:03 GMT -->
