...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：匕部（ひ・さじ・さじのひ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>匕部とは？</h2>
                              <p>匕は、さじの形、または人の形（人を逆さにした形）にかたどっていますが、これを元に作られた字はきわめて少ないと言われており、<strong>匕部（ひぶ）には<span
                                             class="marker">「匕」の形を構成にした字</span>が属します。</strong>「匕」は「ひ」「さじ」「さじのひ」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>匕（さじ・さじのひ）</option>
                                        ...
                                        <option value="#" selected>匕（ひ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02014">漢検級順</a></li>
                                   <li><a href="cbushu02014">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：匕部（ひ・さじ・さじのひ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical21">English</option>
                                             <option value="bushu02014">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu02014 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:30 GMT -->
