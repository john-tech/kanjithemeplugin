...
<div id="all">
    ...
    <div id="wrapper" class="cf">
        <div id="content">
            <h1 class="ttl_main">部首：舛部（まいあし・ます）の漢字</h1>

            <div class="bushu_about">
                <div class="bushu_about_box">
                    <h2>舛部とは？</h2>
                    <p><strong>舛部（せんぶ）は、<span
                                class="marker">「舛」の形を構成にした字</span>が属します。</strong>「舛」は「ます」、舞の脚の部分であることから「まいあし」と呼びます。「舛」は、６画として扱われる場合と７画として扱われる場合があります。
                    </p>
                </div>
            </div>
            <div class="parts_data">
                <div class="search_narrowdown">
                    ...
                    <div class="narrowdown_select">
                        <select name="select" onChange="location.href=value;" class="select1">
                            ...
                            <option value="#" selected>舛（まいあし）</option>
                            ...
                            <option value="#" selected>舛（ます）</option>
                ...
                <div class="search_data bushu_menu">
                    <ul class="search_menu">
                        <li>画数順</li>
                        <li><a href="bbushu07019">漢検級順</a></li>
                        <li><a href="cbushu07019">読み順</a></li>
                    </ul>
                ...
                <h2 class="left_border">部首：舛部（まいあし・ます）の漢字一覧</h2>
                    ...
                    <div class="language_footer">
                        <div class="lan_inner">
                            <select name="select" onChange="location.href=value;" tabindex="0">
                                ...
                                <option value="radical136">English</option>
                                <option value="bushu07019">Japanese</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from bushu07019 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:16 GMT -->
