...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：八部（はち・はちがしら・は）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>八部とは？</h2>
                              <p><strong>八部（はちぶ）は、八の字をもとに作られた字はなく、<span
                                             class="marker">主に字形から文字を整理するために設けられた部首であり、特定の意味は持たない</span>とされます。</strong>一説によれば「六」や「公」は八を元作られたとも言われています。「八」は「はち」「は」、冠（かんむり）になった形を「はちがしら」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02008">漢検級順</a></li>
                                   <li><a href="cbushu02008">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：八部（はち・はちがしら・は）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts06">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/12690">关</a></li>
                                        <li><a href="kanjiy/13119">兲</a></li>
                                        <li><a href="kanjiy/13120">兴</a></li>
                                        <li><a href="kanjiy/18622">龹</a></li>
                                        <li><a href="kanjiy/27760">𠔉</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts07">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/18756">㒶</a></li>
                                        <li><a href="kanjiy/26414">㒷</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="parts_box" id="parts11">
                                   ...
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/24686">兽</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts13">
                                   <h3 class="ttl_while"><a href="kakusu13">１３画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/12692">兾</a></li>
                                        <li><a href="kanjiy/24688">兿</a></li>
                                   </ul>
                              </div>
