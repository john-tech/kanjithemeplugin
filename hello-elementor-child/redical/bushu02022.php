...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：卜部（ぼく・ぼくのと・と・うらない）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>卜部とは？</h2>
                              <p><strong>卜部（ぼくぶ）は、<span
                                             class="marker">占いに関する字、「卜」の形を構成にした字</span>などが属します。</strong>「卜」は「ぼく」「ぼくのと」「と」「うらない」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>卜（うらない）</option>
                                        ...
                                        <option value="#" selected>卜（と）</option>
                                        ...
                                        <option value="#" selected>卜（ぼく）</option>
                                        <option value="bushu04012">攴 攵（ぼくづくり・ぼくにょう）</option>
                                        <option value="#" selected>卜（ぼくのと）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu02022">漢検級順</a></li>
                                   <li><a href="cbushu02022">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：卜部（ぼく・ぼくのと・と・うらない）の漢字一覧</h2>
                         <div class="bushu_wrap">
                              ...
                              <div class="parts_box" id="parts05">
                                   ...
                                   <ul class="search_parts">
                                        ...
                                        <li><a href="kanjiy/13171">卟</a></li>
                                        <li><a href="kanjiy/13172">卡</a></li>
                                        <li><a href="kanjiy/24739">卢</a></li>
                                   </ul>
                              </div>
                              <div class="parts_box" id="parts07">
                                   <h3 class="ttl_while"><a href="kakusu07">７画</a></h3>
                                   <ul class="search_parts">
                                        <li><a href="kanjiy/13173">卣</a></li>
                                        <li><a href="kanjiy/13174">卤</a></li>
                                   </ul>
                              </div>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical25">English</option>
                                             <option value="bushu02022">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu02022 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:39:35 GMT -->
