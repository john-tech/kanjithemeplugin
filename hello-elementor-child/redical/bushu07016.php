...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：豕部（いのこ・いのこへん・ぶた）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>豕部とは？</h2>
                              <p><strong>豕部（しぶ）は、<span
                                             class="marker">猪（いのしし）や豚（ぶた）、それに似た動物などに関する字</span>が主に属します。</strong>「豕」は「いのこ」「ぶた」、偏になった形を「いのこへん」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>豕（いのこ）</option>
                                        <option value="bushu03035">彑 彐（いのこがしら）</option>
                                        <option value="#" selected>豕（いのこへん）</option>
                                        ...
                                        <option value="#" selected>豕（ぶた）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu07016">漢検級順</a></li>
                                   <li><a href="cbushu07016">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：豕部（いのこ・いのこへん・ぶた）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical152">English</option>
                                             <option value="bushu07016">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu07016 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:41:29 GMT -->
