...
div#sidebar {
    display: none;
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：丶部（てん・ちょぼ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>丶部とは？</h2>
                              <p><strong>丶部（ちゅぶ）は、<span
                                             class="marker">主に字形から文字を整理するために設けられた部首であり、特定の意味は持たない</span>とされます。</strong>「丶」は「てん」「ちょぼ」と呼びます。
                              </p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>丶（ちょぼ）</option>
                                        ...
                                        <option value="#" selected>丶（てん）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu01004">漢検級順</a></li>
                                   <li><a href="cbushu01004">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：丶部（てん・ちょぼ）の漢字一覧</h2>
