...
?>
  ...
  <div class="contents_bnr link_sp">
          ...
          <div id="wrapper" class="cf">
               <div id="content">
                    <h1 class="ttl_main">部首：氏部（うじ）の漢字</h1>

                    <div class="bushu_about">
                         <div class="bushu_about_box">
                              <h2>氏部とは？</h2>
                              <p><strong>氏部（しぶ）は、主に字形から文字を整理するために設けられた部首であり、類似の形をした字を含めて、<span
                                             class="marker">「氏」の形を構成にした字</span>が属します。「氏」は「うじ」と呼びます。</strong></p>
                         </div>
                    </div>
                    <div class="parts_data">
                         <div class="search_narrowdown">
                              ...
                              <div class="narrowdown_select">
                                   <select name="select" onChange="location.href=value;" class="select1">
                                        ...
                                        <option value="#" selected>氏（うじ）</option>
                         ...
                         <div class="search_data bushu_menu">
                              <ul class="search_menu">
                                   <li>画数順</li>
                                   <li><a href="bbushu04024">漢検級順</a></li>
                                   <li><a href="cbushu04024">読み順</a></li>
                              </ul>
                         ...
                         <h2 class="left_border">部首：氏部（うじ）の漢字一覧</h2>
                              ...
                              <div class="language_footer">
                                   <div class="lan_inner">
                                        <select name="select" onChange="location.href=value;" tabindex="0">
                                             ...
                                             <option value="radical83">English</option>
                                             <option value="bushu04024">Japanese</option>
                                        </select>
                                   </div>
                              </div>
                         </div>
...
<!-- Mirrored from bushu04024 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 00:40:30 GMT -->
