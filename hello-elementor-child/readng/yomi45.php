     ...
     <div id="wrapper" class="cf">
          <div id="content">
               ...
               <div class="search_narrowdown">
                    ...
                    <div class="narrowdown_select">
                         <select name="select" onChange="location.href=value;" class="select1">
                              ...
                              <option value="#" selected>を</option>
                         </select>
                    </div>
               </div><!--search_narrowdown-->
               <div class="search_data yomi_menu">
                    <ul class="search_menu2">
                         <li id="parts1_menu"><a href="#parts1">を</a></li>
                    </ul>
               </div><!--search_data-->
               ...
               <div class="parts_box parts_box_select" id="parts1">
                    <h3 class="ttl_while">を</h3>
                    <ul class="search_parts yomi_parts">
                         <li class="jimmei kunyomi"><a class="color2" href="2374">乎<span class="small">を</span></a></li>
                    </ul>
               </div><!--parts_box-->
